...
- ตัวสร้างรายงานใน Power BI [ดาวน์โหลดและติดตั้งตัวสร้างรายงานใน Power BI](https://aka.ms/pbireportbuilder)
...
- ถ้าคุณต้องการใช้ชุดข้อมูล Power BI ที่ใช้ DirectQuery ใน Power BI Report Builder ชุดข้อมูลจะต้องรวมหน่วยวัด แม้ว่าคุณจะไม่ได้วางแผนที่จะแสดงหน่วยวัดในรายงานของคุณก็ตาม หากไม่มีหน่วยวัด ชุดข้อมูลจะไม่ส่งคืนผลลัพธ์ข้อมูลที่เหมาะสม
