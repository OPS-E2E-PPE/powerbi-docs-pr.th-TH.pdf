...
ผู้ดูแลระบบของ Power BI สามารถปรับเปลี่ยนเปอร์เซ็นต์หน่วยความจำสูงสุดตามค่าเริ่มต้นในพอร์ทัลผู้ดูแลระบบ ดูส่วนปริมาณงาน **รายงานที่มีการแบ่งหน้า** ภายใต้ **Power BI Premium** บนแท็บ **การตั้งค่าความจุ**
...
เมื่อดูรายงานที่มีการแบ่งหน้าในบริการ Power BI เซสชันอาจหมดเวลาให้นำเสนอผู้ใช้ที่มีการแจ้งเตือนต่อไปนี้:
...
- เซสชันจะหมดเวลาหลังจาก 60 นาทีของการไม่ได้ใช้งาน หรือก่อนหน้านี้เมื่ออุปกรณ์ถูกล็อกหรือไม่ได้ใช้งาน หรือเมื่อไม่มีการแสดงรายงานในแท็บ active ของเบราว์เซอร์
