...
สำหรับข้อมูลเพิ่มเติม ดู [แผนที่ ArcGIS ใน Power BI](power-bi-visualizations-arcgis.md)
...
ถ้าแดชบอร์ดของคุณไม่มีเขตข้อมูลถามตอบอาจถูกปิดใช้งานโดยผู้ดูแลระบบ Power BI ของคุณ 
