...
ด้วยการแสดงผลด้วยภาพเมทริกซ์คุณสามารถทำการดูรายละเอียดแนวลึกที่น่าสนใจทุกประเภทที่ไม่เคยมีมาก่อน ซึ่งรวมถึงความสามารถในการดูรายละเอียดแนวลึกที่ระดับแถว คอลัมน์ และแม้แต่ส่วนและเซลล์ ลองมาดูวิธีการดูรายละเอียดแนวลึก
...
ในรูปภาพต่อไปนี้ส่วน **แถว** ประกอบด้วย *ระยะการขาย* และ *ขนาดโอกาส* ซึ่งสร้างการจัดกลุ่ม (หรือลำดับชั้น) ในแถวที่เราสามารถเจาะลึกเพื่อดูรายละเอียด
...
คล้ายกับการดูรายละเอียดและขยายดูข้อมูลในภาพอื่น ๆ การเลือกปุ่มเหล่านี้ช่วยให้เราสามารถดูรายละเอียดแนวลึก (หรือย้อนกลับ) ตามลำดับชั้น ในกรณีนี้เราสามารถเจาะลึกตั้งแต่ *ขั้นตอนการขาย* จนถึง *ขนาดโอกาส* ดังที่แสดงในภาพต่อไปนี้โดยที่ไอคอน **เจาะลึกระดับหนึ่ง** (รูปแฉก ) ที่ถูกเลือกแล้ว
...
เลือกไอคอน **ดูรายละเอียดแบบเจาะลึก** เพื่อกลับไปที่มุมมองระดับบนสุดก่อนหน้านี้ ถ้าคุณเลือก **ข้อเสนอ** > **แสดงระดับถัดไป** คุณจะได้รายการตามลำดับของรายการในระดับถัดไปทั้งหมด (ในกรณีนี้ คือเขตข้อมูล *ขนาดของโอกาส*) โดยไม่มีลำดับชั้นสูงกว่าของการจัดประเภท
...
> [!NOTE]
> ไอคอนดูรายละเอียดแนวลึก และดูข้อมูลสรุป ที่มุมบนซ้ายของวิชวลเมทริกซ์ ใช้กับแถวเท่านั้น เมื่อต้องดูรายละเอียดแนวลึกที่ระดับคอลัมน์ คุณต้องใช้เมนูคลิกขวา
