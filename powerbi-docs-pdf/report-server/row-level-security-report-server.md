...
ทำเครื่องหมายที่ช่องนี้เมื่อใช้งาน[การรักษาความปลอดภัยระดับแถวแบบไดนามิก](/analysis-services/tutorial-tabular-1200/supplemental-lesson-implement-dynamic-security-by-using-row-filters)ตามชื่อผู้ใช้หรือรหัสล็อกอิน 
...
1. ใน Power BI Desktop บันทึกรายงานไปยังเซิร์ฟเวอร์รายงาน Power BI คุณจำเป็นต้องใช้เวอร์ชันของ Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI
...
การมอบหมายบทบาทผ่านการเป็นสมาชิกของกลุ่มจะได้รับการสนับสนุนเมื่อมีการกำหนดค่าเซิร์ฟเวอร์รายงาน Power BI เพื่อเรียกใช้ด้วยการรับรองความถูกต้องแบบ NTLM หรือ Kerberos เซิร์ฟเวอร์ที่ใช้งานกับการรับรองความถูกต้องแบบกำหนดเองหรือ Windows Basic ต้องการผู้ใช้ที่ได้รับมอบหมายอย่างชัดเจนให้บทบาท
