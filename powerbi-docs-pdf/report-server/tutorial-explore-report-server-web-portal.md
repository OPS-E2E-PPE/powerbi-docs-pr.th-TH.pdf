...
|![เลขที่ 3](media/tutorial-explore-report-server-web-portal/number-3.png) | เริ่มต้น Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI (มกราคม๒๐๒๑) |
...
1. เลือก **อนุญาต** เพื่ออนุญาตให้เว็บไซต์นี้เปิดโปรแกรมบนคอมพิวเตอร์ของคุณ 
     ...
     หน้ารายงานเปิดขึ้นใน Power BI Desktop หมายเหตุชื่อในแถบด้านบน "Power BI Desktop (มกราคม๒๐๒๑)" นี่เป็นเวอร์ชันที่ปรับให้เหมาะสำหรับเซิร์ฟเวอร์รายงาน Power BI
