...
ms.locfileid: "99087096"
---
# <a name="whats-new-in-power-bi-report-server"></a>มีอะไรใหม่ใน Power BI Report Server

เรียนรู้ว่ามีอะไรใหม่ในเซิร์ฟเวอร์รายงาน Power BI และ Power BI Desktop รุ่นล่าสุดสำหรับเซิร์ฟเวอร์รายงาน Power BI บทความนี้ครอบคลุมคุณสมบัติที่สำคัญและจะมีการอัปเดตสำหรับเวอร์ชั่นใหม่ ๆ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับส่วนประกอบใหม่ ๆ ในเซิร์ฟเวอร์รายงาน Power BI ให้ดู [บันทึกการเปลี่ยนแปลงสำหรับเซิร์ฟเวอร์รายงาน Power BI](changelog.md)

ดาวน์โหลด[เซิร์ฟเวอร์รายงาน Power BI และ Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI](https://powerbi.microsoft.com/report-server/)

## <a name="january-2021"></a>มกราคม 2021

ต่อไปนี้คือรายการของคุณลักษณะใหม่และอัปเดต สำหรับรายละเอียดดู[บล็อกเซิร์ฟเวอร์รายงาน Power BI โพสต์สำหรับเดือนมกราคม๒๐๒๑](https://powerbi.microsoft.com/blog/power-bi-report-server-january-2021-feature-summary/)

### <a name="power-bi-desktop-for-power-bi-report-server"></a>Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI

ต่อไปนี้คือไฮไลท์บางส่วนของคุณลักษณะใหม่

**รายงาน Power BI**

- ใช้ตัวกรองทั้งหมดในขณะนี้พร้อมใช้งานโดยทั่วไปแล้ว
- แถบเลื่อนการย่อ/ขยายภาพ
- การตรวจสอบการเพิกถอนใบรับรองสำหรับการเชื่อมต่อเว็บ
- บานหน้าต่างการเลือกในมุมมองเค้าโครงอุปกรณ์เคลื่อนที่
- ArcGIS สำหรับการสนับสนุน Power BI

**การเชื่อมต่อข้อมูล**

- ตัวเชื่อมต่อไฮฟ์ LLAP พร้อมใช้งานโดยทั่วไปแล้ว
- ตัวเชื่อมต่อใหม่: Actian, Anaplan, Starburst

### <a name="new-connection-metadata-format-preview"></a>รูปแบบการเชื่อมต่อเมตาดาต้าใหม่ (ตัวอย่าง)

เราได้อัปเดตข้อมูลเมตาดาต้าของการเชื่อมต่อที่จัดเก็บไว้ในรูปแบบไฟล์ .pbix ในเดือนตุลาคม การอัปเดตนี้เป็นส่วนหนึ่งของการเดินทางระยะยาวเพื่อทำให้ไฟล์ .pbix สามารถเข้าถึงได้และแก้ไขได้ เราได้เปิดใช้งานการเปลี่ยนแปลงในเวอร์ชันของ Power BI Desktop ที่เผยแพร่รายเดือนในบรรทัดด้วยบริการของ Power BI แล้ว เรากำลังแสดงตัวอย่างการเปลี่ยนแปลงในการเผยแพร่นี้ของ Power BI Desktop สำหรับเซิร์ฟเวอร์รายงานเริ่มต้นเดือนนี้

เริ่มต้นด้วยการเผยแพร่นี้คุณจะเห็นการแจ้งเตือนต่อไปนี้เพื่อให้คุณเปิดใช้งานการแสดงตัวอย่างและอัปเกรดเป็นรูปแบบขั้นสูง:

"เร็วๆนี้-เปิดการแสดงตัวอย่างรูปแบบเมตาดาต้าขั้นสูงเพื่อให้ได้ประสิทธิภาพที่ดีขึ้นและการปรับปรุงความปลอดภัยใน Power BI"

สังเกตสิ่งต่อไปนี้:

- ชุดข้อมูลที่มีอยู่จะยังคงทำงานต่อไปแม้ว่าจะไม่มีการปรับรุ่น พวกเขาจะได้รับการปรับรุ่นเมื่อมีการสร้างรูปแบบขั้นสูงที่พร้อมใช้งานโดยทั่วไปแล้ว
- Power BI Desktop สำหรับเซิร์ฟเวอร์รายงานจะอัปเกรดชุดข้อมูลที่มีอยู่ไปยังรูปแบบขั้นสูงสำหรับคุณโดยอัตโนมัติ เราขอแนะนำให้ไม่แทนที่รายงานที่มีอยู่บนเซิร์ฟเวอร์รายงานด้วยเวอร์ชันที่อัปเกรดนี้ในกรณีที่คุณต้องการย้อนกลับไปยังรูปแบบก่อนหน้า
- การเข้าร่วมการแสดงตัวอย่างนี้เป็นทางเลือกแม้ว่าเราขอแนะนำให้คุณทดลองใช้และให้คำติชมแก่เรา เรามุ่งมั่นที่จะทำให้รูปแบบขั้นสูงที่พร้อมใช้งานโดยทั่วไปเป็นตัวเลือกเดียวในรุ่นถัดไปของเซิร์ฟเวอร์รายงาน
 
ในฐานะผู้ดูแลระบบคุณสามารถปิดใช้งานการแสดงตัวอย่างนี้บังคับ V3 ปิดและซ่อนคุณลักษณะการแสดงตัวอย่างกล่องกาเครื่องหมาย ตั้งค่า DWORD ดังต่อไปนี้เป็น0ในรีจิสทรี: AllowV3Models ในหนึ่ง:
...
ดูการ [ใช้เมตาดาต้าชุดข้อมูลขั้นสูง](../connect-data/desktop-enhanced-dataset-metadata.md) สำหรับข้อมูลเพิ่มเติม

### <a name="power-bi-report-server"></a>เซิร์ฟเวอร์รายงาน Power BI

**การสนับสนุนเบราว์เซอร์ deprecation**

ถ้าคุณกำลังใช้ Edge แบบดั้งเดิมหรือ Internet Explorer 11 ก็ถึงเวลาที่จะอัปเกรดเบราว์เซอร์ของคุณ การสนับสนุนสำหรับเบราว์เซอร์แบบดั้งเดิมขอบสิ้นสุดเริ่มต้น9มีนาคม๒๐๒๑ การสนับสนุนสำหรับ Internet Explorer 11 สิ้นสุดเริ่มต้นวันที่17สิงหาคม๒๐๒๑ 

คุณจะเห็นคำเตือนในพอร์ทัลเว็บเซิร์ฟเวอร์รายงาน Power BI ที่ Internet Explorer 11 กำลังถูกยกเลิกการสนับสนุน เวลาที่จะอัปเกรด! ดูที่การ [สนับสนุนเบราว์เซอร์สำหรับการเซิร์ฟเวอร์รายงาน Power BI](browser-support.md) สำหรับรายละเอียด

**ไอคอนผลิตภัณฑ์ใหม่**

เซิร์ฟเวอร์รายงาน Power BI มีไอคอนผลิตภัณฑ์ใหม่ในการรักษาด้วยไอคอนใหม่ที่ใช้งานร่วมกันในผลิตภัณฑ์ของ Microsoft ทั้งหมด

:::image type="content" source="media/whats-new/power-bi-report-server-new-logo.png" alt-text="เซิร์ฟเวอร์รายงาน Power BI โลโก้ใหม่":::

## <a name="october-2020"></a>ตุลาคม 2020

สิ่งต่อไปนี้เป็นรายการทั้งหมดของคุณลักษณะใหม่และอัปเดต สำหรับรายละเอียด โปรดดู[โพสต์บล็อก Power BI Report Server สำหรับพฤษภาคม 2020](https://powerbi.microsoft.com/blog/power-bi-report-server-october-2020-feature-summary/) 
...
Ribbon สมัยใหม่มาถึง Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI เราจะดำเนินการเพิ่มเติมและเพิ่มคุณลักษณะลงในริบบอนมากขึ้นต่อไป โปรดดู[ใช้ริบบอนที่ปรับปรุงแล้วใน Power BI Desktop](../create-reports/desktop-ribbon.md) เพื่อเรียนรู้เพิ่มเติมเกี่ยวกับการเปลี่ยนแปลงและประโยชน์

:::image type="content" source="media/whats-new/report-server-new-ribbon.png" alt-text="สกรีนช็อตของ ribbon ใหม่ใน Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI":::

**ตัวแบ่งส่วนข้อมูลลำดับชั้น**

คุณสามารถสร้างสิ่งที่เรียกว่า *ตัวแบ่งส่วนข้อมูลลำดับชั้น* เพื่อกรองเขตข้อมูลที่เกี่ยวข้องหลายเขตข้อมูลในตัวแบ่งส่วนข้อมูลเดียว ขณะนี้มีให้บริการโดยทั่วไปแล้ว ซึ่งจะได้รับประโยชน์จากฟังก์ชันเพิ่มเติมต่อไปนี้:

- ตัวเลือกใหม่สำหรับไอคอนขยาย/ยุบ
- มาตราส่วนปัจจุบันของไอคอนตามขนาดตัวอักษร
- การเยื้องที่ปรับแต่งได้สำหรับรายการย่อย
- การกำหนดค่าเพิ่มเติมสำหรับข้อความส่วนหัวของตัวแบ่งส่วนข้อมูล

:::image type="content" source="media/whats-new/report-server-slicer-hierarchy.png" alt-text="ตัวแบ่งลำดับชั้นใน Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI":::

โปรดดูรายละเอียดที่[ตัวแบ่งส่วนข้อมูลใน Power BI](../visuals/power-bi-visualization-slicers.md) ในเอกสารประกอบ

**การเพิ่มประสิทธิภาพการเขียนโดยใช้อุปกรณ์เคลื่อนที่** 

ในการเผยแพร่นี้เราจะแนะนำประสบการณ์การเขียนเค้าโครงมือถือที่ปรับปรุงและความสามารถในการจัดรูปแบบมือถือมากขึ้น ในฐานะที่เป็นองค์กรเพิ่มเติมได้นำแอป Power BI สำหรับอุปกรณ์เคลื่อนที่มาใช้แล้วเราได้รับคำติชมจากการขอความสามารถและการปรับปรุงสำหรับประสบการณ์การเขียนแบบมือถือ การเพิ่มประสิทธิภาพในการเผยแพร่นี้จะช่วยให้คุณสามารถสร้างรายงานเชิงโต้ตอบที่น่าสนใจและเหมาะสำหรับอุปกรณ์เคลื่อนที่ได้ง่ายขึ้น

ประสบการณ์และความสามารถใหม่ ๆ ในการสร้างรายงานที่ปรับให้เหมาะกับอุปกรณ์เคลื่อนที่มีดังนี้  

- ตัวจำลองโทรศัพท์ใหม่  
- บานหน้าต่างการแสดงผลด้วยภาพที่อัปเดตใหม่  
- การสนับสนุนสำหรับวิชวลแบบวางซ้อนทับ  
- ที่คั่นหน้าพร้อมใช้งานในมุมมองเค้าโครงอุปกรณ์เคลื่อนที่  
- ปิดใช้งานเส้นตารางและจัดชิดกับเส้นตาราง  

:::image type="content" source="media/whats-new/report-server-mobile-layout.png" alt-text="รูปแบบมือถือที่ปรับปรุงแล้วใน Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI":::

ดูรายละเอียดในบล็อกโพสต์[การเพิ่มประสิทธิภาพการเขียนโดยใช้อุปกรณ์เคลื่อนที่](https://powerbi.microsoft.com/blog/power-bi-desktop-june-2020-feature-summary/#_mobile)

**การเตรียมข้อมูล: การตรวจหาตารางโดยอัตโนมัติจากไฟล์ Excel**

คุณลักษณะใหม่ของตัวเชื่อมต่อ Excel จะระบุส่วนของสเปรดชีต Excel แต่ละรายการโดยอัตโนมัติเพื่อแยกลงในตาราง โดยจะแสดงรายการเหล่านี้ภายใต้กลุ่ม “ตารางที่แนะนำ” ในตัวนำทาง ก่อนหน้านี้ข้อมูลต้องจัดรูปแบบเป็นตารางหรือช่วงที่มีการตั้งชื่อใน Excel มิฉะนั้นคุณจะต้องดึงข้อมูลจากแถว/คอลัมน์ที่เกี่ยวข้องด้วยการแปลงเฉพาะ เช่น ข้ามแถวและลบคอลัมน์ออกจากวัตถุในเวิร์กชีตเช่นเดียวกับใน Sheet1 ในตัวอย่างต่อไปนี้ เมื่อต้องการใช้คุณลักษณะนี้ คุณต้องเปิดใช้งานในกล่องโต้ตอบ **การตั้งค่า**

:::image type="content" source="media/whats-new/report-server-excel-table.png" alt-text="การจดจำตาราง Excel ใน Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI":::

**การสร้างแบบจำลอง: เมตาดาต้าชุดข้อมูลที่ปรับปรุงประสิทธิภาพแล้ว**

ในอดีตจะแมปเฉพาะคิวรีที่สามารถโหลดได้ซึ่งถูกสร้างขึ้นใน Power Query เท่านั้นกับแบบจำลองข้อมูล แต่ในตอนนี้จะแมปคิวรีทั้งหมดกับวัตถุในแบบจำลองข้อมูล คิวรีจะถูกสร้างขึ้นใหม่ตามแบบจำลองข้อมูลเมื่อคุณเปิดไฟล์ PBIX นั้น

การอัปเดตแบ็กเอนด์นี้ปลดล็อกการปรับปรุงคุณลักษณะในอนาคตและจะดำเนินการต่อไป 

ตัวอย่างเช่น:

- ด้วยการเพิ่มเครื่องมือภายนอกใน Power BI Desktop (ขณะนี้อยู่ในการแสดงตัวอย่าง) ตารางที่คุณเพิ่มผ่านเครื่องมือภายนอกเหล่านี้จะปรากฏเป็นคิวรีเมื่อคุณเปิดรายงานของคุณอีกครั้ง
- หากคุณพยายามส่งออกไฟล์ PBIT และคลายซิปไฟล์ตอนนี้ คุณจะเห็นแบบจำลองใน JSON และไม่ได้รับข้อผิดพลาดเกี่ยวกับไฟล์ที่เสียหายอีกต่อไป 

ถ้าคุณมี .PBIX ที่เก่ากว่าซึ่งไม่สามารถอัปเดตโดยอัตโนมัติได้ด้วยเหตุผลเช่นการเปลี่ยนแปลงที่ไม่ได้ใช้งานคุณต้องอัปเกรดรุ่นของคุณให้เสร็จสมบูรณ์ก่อนที่คุณจะสามารถทำการเปลี่ยนแปลงแบบจำลองอื่นๆได้ 

**การสนับสนุนสำหรับ Windows 7 สิ้นสุดลง**

การสนับสนุนสำหรับ Windows 7 สิ้นสุดลงในวันที่ 14 มกราคม 2020 หลังจากผ่านมา 10 ปี ในบรรทัดที่มีการเปลี่ยนแปลงนี้เราจะหยุดการสนับสนุนสำหรับ Power BI Desktop บน Windows 7 เมื่อวันที่31มกราคม๒๐๒๑ หลังจากนั้น Power BI Desktop จะได้รับการสนับสนุนบน Windows 8 และใหม่กว่าเท่านั้น Power BI Desktop รุ่นเผยแพร่เดือนมกราคม 2021 ที่ปรับให้เหมาะสมสำหรับ Report Server จะได้รับการสนับสนุนตามนโยบายวงจรชีวิตสมัยใหม่ กล่าวอีกนัยหนึ่งก็คือได้รับการสนับสนุนอย่างสมบูรณ์จนถึงรุ่นการเผยแพร่ถัดไป (ปัจจุบันมีกำหนดเผยแพร่ในเดือนพฤษภาคม 2021) หลังจากเดือนพฤษภาคม 2021 จะมีการอัปเดตความปลอดภัยจนถึงเดือนมกราคม 2022 เท่านั้น การสนับสนุนทั้งหมดจะหยุดลงหลังจากเดือนมกราคม 2022 ดูรายละเอียดใน[ไทม์ไลน์การสนับสนุน Power BI Report Server](support-timeline.md) 

**รายการอัปเดตทั้งหมด**

นี่คือรายการทั้งหมดของการอัปเดตใน Power BI Desktop รุ่นเดือนตุลาคมสำหรับเซิร์ฟเวอร์รายงาน Power BI 

**การรายงาน**

- ริบบอนที่ทันสมัย
- ลายน้ำพื้นที่ทำงาน
- ป้ายชื่อทั้งหมดสำหรับวิชวลแบบเรียงซ้อน
- เพิ่มตัวเลือกวิชวลโดยทั่วไปเพื่อรักษาลำดับของชั้น
- คำอธิบายแผนภูมิการไล่ระดับสี
- ตัวกรองเวลาสัมพัทธ์
- ความสามารถในการปรับแต่งข้อความส่วนหัวของตัวแบ่งข้อมูล
- การปรับปรุงตัวแบ่งส่วนข้อมูลแบบลำดับชั้น

    - ตัวเลือกใหม่สำหรับไอคอนขยาย/ยุบ
    - มาตราส่วนปัจจุบันของไอคอนตามขนาดตัวอักษร
    - ความสามารถในการปรับแต่งการเยื้องสำหรับรายการย่อย
...
- ตัวเลือกการจัดรูปแบบจุดแผนภูมิเส้น 

**สร้างรูปแบบข้อมูล**

- เมตาดาต้าชุดข้อมูลที่ปรับปรุงประสิทธิภาพแล้ว
- การปรับปรุงประสิทธิภาพของฟังก์ชัน IF และ SWITCH
- การสนับสนุนฟังก์ชันทางการเงินของ Excel
- เปิดใช้งานมุมมองแบบจำลองสำหรับการเชื่อมต่อแบบสด
- อัปเดตไปยังมุมมองแบบจำลอง 

**การเตรียมข้อมูล**

- การตรวจหาตารางโดยอัตโนมัติจากไฟล์ Excel  
- การตรวจหาตารางโดยอัตโนมัติจากไฟล์ JSON  
- ตัวเลือกส่วนกลางเพื่อปิดใช้งานการตรวจหาประเภทอัตโนมัติ 

**อื่น ๆ**  

- ส่งออกแหล่งข้อมูลไปยัง PBIDS ใน Power BI Desktop
- ยกเลิกหน้าจอเริ่มต้นของ Desktop 

### <a name="power-bi-report-server"></a>เซิร์ฟเวอร์รายงาน Power BI

**เปลี่ยนสตริงการเชื่อมต่อแหล่งข้อมูลในรายงาน Power BI ด้วย PowerShell**

ใน Power BI Report Server รุ่นการเผยแพร่เดือนตุลาคม เรากำลังเปิดใช้ความสามารถเพื่ออัปเดตการเชื่อมต่อสำหรับรายงาน Power BI สำหรับ DirectQuery และการรีเฟรช ความสามารถนี้ยังเป็นการเปลี่ยนแปลงการแบ่งในวิธีที่คุณสามารถตั้งค่าในการเผยแพร่ก่อนหน้านี้ หากต้องการเรียนรู้เพิ่มเติม โปรดดู[เปลี่ยนสตริงการเชื่อมต่อแหล่งข้อมูลในรายงาน Power BI ด้วย PowerShell - เซิร์ฟเวอร์รายงาน Power BI](connect-data-source-apis.md) 
...
เลือกฉลากกำกับหมวดหมู่ของแกนในส่วนการแสดงผลเพื่อแรเงาโยงองค์ประกอบอื่น ๆ ในหน้า เหมือนกับการเลือกจุดข้อมูลในส่วนการแสดงผล อ่านรายละเอียดเพิ่มเติมเกี่ยวกับ[การแรเงาโยง](../create-reports/power-bi-reports-filters-and-highlighting.md#ad-hoc-cross-filtering-and-cross-highlighting)
...
สิงหาคม๒๐๑๘เห็นคุณลักษณะใหม่จำนวนมากที่เพิ่มไปยังเวอร์ชันของ Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI ต่อไปนี้จะเป็นการแจกแจงข้อมูลตามพื้นที่:
...
มีนาคม๒๐๑๘เห็นจำนวนมากคุณลักษณะใหม่จำนวนมากที่เพิ่มไปยังเวอร์ชันของ Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI ต่อไปนี้จะเป็นการแจกแจงข้อมูลตามพื้นที่:
...
คุณต้องการให้ผู้อ่านสามารถเข้าถึงรายงานของคุณได้แต่บางหน้าไม่เสร็จสิ้น ในตอนนี้ คุณสามารถซ่อนหน้าเหล่านี้ไว้จนกว่าจะพร้อม หรือคุณสามารถซ่อนหน้าเหล่านี้จากการนำทางปกติ และผู้อ่านสามารถเข้าถึงหน้าโดยการสร้างบุ๊กมาร์กหรือเข้าถึงรายละเอียด
