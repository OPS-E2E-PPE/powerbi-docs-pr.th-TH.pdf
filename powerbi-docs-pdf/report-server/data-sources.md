...
ms.locfileid: "99044275"
---
# <a name="power-bi-report-data-sources-in-power-bi-report-server"></a>แหล่งข้อมูลรายงาน Power BI ใน Power BI Report Server
รายงาน Power BI สามารถเชื่อมต่อกับหลาย ๆ แหล่งข้อมูลได้ ขึ้นอยู่กับวิธีการใช้ข้อมูล แหล่งข้อมูลที่แตกต่างกันสามารถใช้งานได้ สามารถนำเข้าข้อมูล หรือข้อมูลสามารถถูกคิวรี่ได้โดยตรงโดยใช้ DirectQuery หรือการเชื่อมต่อตรงกับ SQL Server Analysis Services บางแหล่งข้อมูลสามารถใช้งานได้ใน Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI แต่ไม่ได้รับการสนับสนุนเมื่อเผยแพร่ไปยังเซิร์ฟเวอร์รายงาน Power BI

แหล่งข้อมูลเหล่านี้จะใช้เฉพาะกับรายงาน Power BI ที่ใช้ภายในเซิร์ฟเวอร์รายงาน Power BI สำหรับข้อมูลเกี่ยวกับแหล่งข้อมูลที่สนับสนุนรายงานที่มีการแบ่งหน้า (.rdl) ดูที่[ข้อมูลแหล่งข้อมูลที่สนับสนุนโดย Reporting Services](/sql/reporting-services/report-data/data-sources-supported-by-reporting-services-ssrs)
...
Power BI Report Server มีข้อจำกัดเมื่อใช้ข้อมูลบนเว็บ: รีเฟรชได้เฉพาะไฟล์ข้อมูลจากเว็บเท่านั้น ข้อมูลตามหน้าเพจหรือตามตัวอย่างจะไม่สามารถรีเฟรชได้ ข้อจำกัดนี้เป็นเพราะนิพจน์ M ที่สร้างขึ้นด้วย Web.BrowserContents และ Web.Page ที่ไม่สามารถรีเฟรชได้ Power BI Report Server สามารถรีเฟรชได้เฉพาะแหล่งข้อมูล Web.Contents เท่านั้น
...
[แหล่งข้อมูลสำหรับรายงาน Power BI](../connect-data/power-bi-data-sources.md)ในบริการของ Power BI
