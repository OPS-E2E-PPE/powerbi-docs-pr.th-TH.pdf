...
- **เซิร์ฟเวอร์รายงาน Power BI**
    - *เวอร์ชัน: 1.10.7698.12811 (สร้าง 15.0.1105.194), เผยแพร่: มกราคม 21, ๒๐๒๑*
        - คุณลักษณะ
            - ไอคอนใหม่ releate ไปยัง Power BI และรายงาน Power BI
            - API วิชวลแบบกำหนดเองที่จัดส่งด้วยเวอร์ชันเผยแพร่3.5.0
            - ประสบการณ์การแสดงตัวอย่างพอร์ทัลใหม่เพิ่มอยู่หลังสวิตช์คุณลักษณะ ' UsePortalV2 ' ในตาราง ConfigurationInfo ของแค็ตตาล็อก ReportServer
        - แก้ไขข้อบกพร่อง
            - แก้ไขปัญหาด้วยการรีเฟรชที่กำหนดเวลาไว้ของรายงาน Power BI ด้วยโมเดลบางรุ่นโดยใช้เมตาดาต้าแบบจำลองขั้นสูง
            - แก้ไขปัญหาการแก้ไขการสมัครใช้งานแบบจำลองข้อมูลในพอร์ทัล
        - ปรับปรุงความปลอดภัย

- **Power BI Desktop (ที่ปรับให้เหมาะสำหรับเซิร์ฟเวอร์รายงาน Power BI)**
   - *เวอร์ชัน: 2.88.1382.0 (มกราคม๒๐๒๑), เผยแพร่: มกราคม 21, ๒๐๒๑* (สร้างใหม่และรุ่นใหม่)
        - มีการเปลี่ยนแปลงที่จำเป็นสำหรับการเชื่อมต่อกับเซิร์ฟเวอร์รายงาน Power BI (มกราคม๒๐๒๑)        
   
## <a name="october-2020"></a>ตุลาคม 2020
- **เซิร์ฟเวอร์รายงาน Power BI**
    - *เวอร์ชัน: 1.9.7675.15620 (รุ่น 15.0.1104.300) เผยแพร่เมื่อ: 8 มกราคม 2021*
        - แก้ไขข้อบกพร่อง
            - แก้ไขปัญหาเกี่ยวกับการรีเฟรชรายงานที่มีแหล่งข้อมูลตั้งแต่สองแหล่งขึ้นไป ซึ่งแตกต่างกันเฉพาะการระบุโครงสร้างตัวอักษรเท่านั้น
            - แก้ไขปัญหาเกี่ยวกับการรีเฟรชการรวมชุดรายงานบางประเภทที่มีการรวมซ้อนกันแล้ว
    - *เวอร์ชัน: 1.9.7627.11028 (รุ่น 15.0.1104.264) เผยแพร่เมื่อ: 18 พฤศจิกายน 2020*
        - แก้ไขข้อบกพร่อง
            - แก้ไขปัญหาที่ป้องกันไม่ให้ผู้ใช้เปลี่ยนแปลงเขตข้อมูลในการตั้งค่าไซต์ผ่านพอร์ทัล
            - แก้ไขปัญหาเกี่ยวกับการรีเฟรชรายงาน Power BI เมื่อใช้แหล่งข้อมูล 'EnterData'
            - แก้ไขปัญหาเกี่ยวกับการรีเฟรชแบบจำลองบางรุ่นโดยใช้เมตาดาต้าชุดข้อมูลที่ปรับปรุงประสิทธิภาพแล้ว
            - แก้ไขปัญหาที่รายงาน Power BI บางรายงานไม่สามารถเผยแพร่ไปยังเซิร์ฟเวอร์รายงานได้
    - *เวอร์ชัน: 1.9.7604.41261 (รุ่น 15.0.1104.239) เผยแพร่เมื่อ: 27 ตุลาคม 2020*
         - คุณลักษณะ
            - เปิดใช้งานการสนับสนุนสำหรับเมตาดาต้าชุดข้อมูลที่ปรับปรุงประสิทธิภาพแล้วใน Power BI Report Server
            - เปิดใช้ความสามารถในการอัปเดตการเชื่อมต่อสำหรับรายงาน Power BI สำหรับ DirectQuery และการรีเฟรช (โปรดดู[เปลี่ยนสตริงการเชื่อมต่อแหล่งข้อมูล](./connect-data-source-apis.md)สำหรับรายละเอียดเพิ่มเติม)
        - ปรับปรุงความปลอดภัย
        - แก้ไขข้อบกพร่อง
            - แก้ไขปัญหาที่ป้องกันไม่ให้ผู้ใช้เปลี่ยนกำหนดการรีเฟรชรายงาน Power BI
            - แก้ไขข้อความแสดงข้อผิดพลาดที่ทำให้ผู้ใช้ที่ได้รับการจัดการรายงานเมื่อข้อมูลประจำตัวหมดอายุเกิดความสับสน
            - แก้ไขปัญหาเกี่ยวกับการส่งออกรายงานที่มีระยะเวลาในชื่อของรายงานดังกล่าว
            - แก้ไขปัญหาโปรแกรมอ่านหน้าจอใน tablix
            - แก้ไขปัญหาไฟล์บันทึกว่างเปล่าในบางสถานการณ์
            - แก้ไขปัญหาด้วยการเขียนทับไฟล์ Excel ในระหว่างการอัปโหลด
            - แก้ไขปัญหาด้วยวิธีการแบบจำลอง UpdateCacheSnapshot REST API
            - แก้ไขปัญหาด้วยการเชื่อมต่อกับแหล่งข้อมูล AP BW ผ่าน XMLA
            - แก้ไขปัญหาที่กล่องโต้ตอบ "เชื่อมต่อกับ Power BI" ไม่ปิด
            - แก้ไขปัญหาด้วยค่าเริ่มต้นของฟีเจอร์ขั้นสูง CustomHeaders
            - อัปเดตตัวแสดงผล MHTML เพื่อใช้ HTML DOCTYPE ที่ใหม่กว่า

- **Power BI Desktop (ที่ปรับให้เหมาะสำหรับเซิร์ฟเวอร์รายงาน Power BI)**
   - *เวอร์ชัน: 2.86.1321.0 (ตุลาคม 2020) เผยแพร่: 18 พฤศจิกายน 2020*
        - แก้ไขข้อบกพร่อง
   - *เวอร์ชัน: 2.86.961.0 (ตุลาคม 2020) เผยแพร่เมื่อ: 27 ตุลาคม 2020* (รุ่นและเวอร์ชั่นใหม่)
        - ประกอบด้วยการเปลี่ยนแปลงที่จำเป็นสำหรับการเชื่อมต่อกับ Power BI Report Server (ตุลาคม 2020)        
...
- **เซิร์ฟเวอร์รายงาน Power BI**
    ...
    - *เวอร์ชัน: 1.8.7450.37410 (รุ่น 15.0.1103.227), เผยแพร่เมื่อ: 27 พฤษภาคม 2020*
         - คุณลักษณะ
            -  เพิ่มการสนับสนุนสำหรับขนาดพูลการเชื่อมต่อแค็ตตาล็อกที่ปรับแต่งได้ (ดู [การตั้งค่า MaxCatalogConnectionPoolSizePerProcess](/sql/reporting-services/report-server/rsreportserver-config-configuration-file#bkmk_service) สำหรับรายละเอียดเพิ่มเติม)
...
- **เซิร์ฟเวอร์รายงาน Power BI**
    - *เวอร์ชัน: 1.6.7364.4075 (รุ่น 15.0.1102.777) เผยแพร่เมื่อ: 2 มีนาคม 2020*
         - แก้ไขข้อบกพร่อง
           ...
           -  แก้ไขการเชื่อมต่อ Oracle โดยใช้ลักษณะเธรดที่ไม่ถูกต้องในสถานการณ์ที่มีผู้ใช้หลายคนบางสถานการณ์ (ดูรายละเอียดเพิ่มเติมที่ [UseInstalledUICulture documentation](./connect-data-sources.md))
...
- **เซิร์ฟเวอร์รายงาน Power BI**
    - *เวอร์ชัน 1.3.6816.37243 (รุ่น 15.0.2.557), เผยแพร่: 30 สิงหาคม 2018*
        - แก้ไขข้อบกพร่อง
            - แก้ไขปัญหาเมื่อเซิร์ฟเวอร์มีการอัปเกรดจากเวอร์ชันก่อนหน้าของเซิร์ฟเวอร์รายงาน PBI ที่เปลี่ยนเส้นทางการผูกที่ไม่มีการอัปเดต ลูกค้าจะเห็นข้อความนี้:      
            *`
...
- **เซิร์ฟเวอร์รายงาน Power BI**
    ...
    - *เวอร์ชัน 1.1.6514.9163 (รุ่น 14.0.600.434), เผยแพร่: 1 พฤศจิกายน 2017*
        - แก้ไขข้อบกพร่อง
            - แก้ไขปัญหาความน่าเชื่อถือการอัปโหลดสำหรับรายงาน PBIX ที่ขนาดใหญ่กว่า 500 MB
            - แก้ไขปัญหาการโหลดข้อมูลสำหรับรายงาน PBIX ที่ขนาดใหญ่กว่า 1 GB
...
- **เซิร์ฟเวอร์รายงาน Power BI**
    ...
    - *รุ่น 14.0.600.305 เผยแพร่: 19 กันยายน 2017*  
        - แก้ไขข้อบกพร่อง
            - ปรับปรุง [Bing Maps Web Control](/bingmaps/v8-web-control/) ให้เป็นรุ่นล่าสุด
    ...
    - *รุ่น 14.0.600.271 เผยแพร่เมื่อ: 12 มิถุนายน 2017*
