...
* [Power BI Desktop สำหรับการ](install-powerbi-desktop.md) ติดตั้งเซิร์ฟเวอร์รายงาน Power BI
* ติดตั้งและกำหนดค่า [สภาพแวดล้อม SharePoint 2013 2016 หรือ 2019](/sharepoint/install/install) แล้ว
...
2. Unzip ไฟล์และเปิดไฟล์ .pbix ตัวอย่างใน Power BI Desktop สำหรับเซิร์ฟเวอร์รายงาน Power BI
