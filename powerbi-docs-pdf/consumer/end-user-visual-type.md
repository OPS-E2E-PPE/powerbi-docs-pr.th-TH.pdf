...
วิชวล (หรือที่เรียกว่า *แผนภูมิ* และ *การแสดงภาพ*) เป็นการแสดงข้อมูลของคุณในรูปแบบภาพ ตัวอย่างทั่วไป คือ แผนภูมิคอลัมน์ แผนที่ แผนภูมิกระจาย และแผนภูมิหน้าปัดความเร็ว คุณจะพบวิชวลในรายงาน แดชบอร์ด และถามตอบ (Q&A)

วิชวลที่อธิบายไว้ในหน้านี้เป็นรายการที่มีอยู่ใน Power BI นี่คือชนิดของวิชวลที่คุณจะพบได้บ่อยที่สุด หน้านี้จะให้ภาพรวมสั้นๆ ของวิชวลที่มีมาให้พร้อมอยู่แล้ว สำหรับข้อมูลเชิงลึกเกี่ยวกับวิชวลเหล่านี้ โปรดดูเอกสารประกอบของ [ผู้ออกแบบรายงาน *Power BI* เกี่ยวกับชนิดของวิชวล](../visuals/power-bi-visualization-types-for-reports-and-q-and-a.md)

วิชวลที่ไม่รวมอยู่ใน Power BI โดยอัตโนมัติจะเรียกว่า *วิชวลแบบกำหนดเอง* วิชวลแบบกำหนดเองสามารถนำเข้าสู่ Power BI จากเว็บไซต์ภายนอกได้ เช่น Microsoft AppSource หรือจากแหล่งข้อมูลภายใน เช่น ร้านค้าในองค์กรของคุณ การนำเข้าวิชวลแบบกำหนดเองต้องมีสิทธิ์การแก้ไขในรายงาน หากต้องการเรียนรู้เกี่ยวกับวิชวลเสริมเหล่านี้ ไปที่ [วิชวลแบบกำหนดเองใน Power BI](../developer/visuals/power-bi-custom-visuals.md)
...
## <a name="d"></a>D    
### <a name="decomposition-tree"></a>โครงข่ายของข้อมูล
![โครงข่ายของข้อมูล](media/end-user-visual-type/power-bi-decomposition.png)

วิชวลโครงข่ายของข้อมูลช่วยให้คุณเห็นภาพข้อมูลในหลายมิติ โดยจะรวมข้อมูลและช่วยให้เจาะลึกลงในมิติของคุณในลำดับใดก็ได้ นอกจากนี้ยังเป็นการแสดงภาพข่าวกรอง (AI) แบบเทียมเพื่อให้คุณสามารถขอให้ค้นหามิติถัดไปเพื่อดูรายละเอียดแนวลึกตามเกณฑ์บางอย่าง ซึ่งทำให้เป็นเครื่องมือที่มีประโยชน์สำหรับการสำรวจแบบเฉพาะกิจและการดำเนินการวิเคราะห์สาเหตุหลัก
...
นักออกแบบรายงานสามารถสร้าง Power App และฝังลงในรายงาน Power BI ได้ *ผู้ใช้ทางธุรกิจ* สามารถโต้ตอบกับวิชวลภายในรายงาน Power BI ได้ 
...
### <a name="smart-narrative"></a>คำบรรยายอัจฉริยะ
![คำบรรยายอัจฉริยะ](media/end-user-visual-type/power-bi-smart-narrative.png)

คำบรรยายอัจฉริยะจะเพิ่มข้อความไปยังรายงานเพื่อชี้แนวโน้ม การประเด็นสำคัญ และเพิ่มคำอธิบายและบริบทต่างๆ ข้อความจะช่วยให้ผู้ใช้เข้าใจข้อมูลและระบุข้อสรุปค้นพบที่สำคัญได้อย่างรวดเร็ว
...
### <a name="tree-maps"></a>แผนภูมิต้นไม้
![แผนภูมิต้นไม้](media/end-user-visual-type/pbi-nancy-viz-tree.png)

แผนภูมิต้นไม้ คือ แผนภูมิสี่เหลี่ยมผืนผ้าสีต่างๆ ที่ขนาดจะแสดงค่าข้อมูล  แผนภูมิเหล่านี้อาจเป็นแบบชั้นโดยที่มีสี่เหลี่ยมผืนผ้าที่ซ้อนกันภายในสี่เหลี่ยมผืนผ้าหลัก ช่องว่างภายในสี่เหลี่ยมผืนผ้าแต่ละจัดไว้ตามค่าที่วัด และสี่เหลี่ยมผืนผ้าจัดเรียงในขนาดจากด้านบนซ้าย (มากที่สุด) ไปด้านล่างขวา (น้อยที่สุด)

แผนภูมิต้นไม้เป็นตัวเลือกที่ดี:
...
"***ยอดขายในแต่ละรัฐในแผนภูมิต้นไม้***"
