...
---
# <a name="view-dashboards-in-the-power-bi-mobile-apps"></a>ดูแดชบอร์ดในแอปมือถือของ Power BI
นำไปใช้กับ:
...
3. ปัดขึ้นหรือลงเพื่อดูไทล์ทั้งหมดในแดชบอร์ด คุณสามารถ:
   ...
   * แตะดาว ![ไม่ใช่รายการดาวโปรด](././media/mobile-apps-view-dashboard/power-bi-mobile-not-favorite-icon.png) เพื่อ [ทำให้เป็นรายการโปรด](mobile-apps-favorites.md)
