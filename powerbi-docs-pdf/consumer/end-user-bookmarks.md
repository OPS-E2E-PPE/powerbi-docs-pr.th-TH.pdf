...
แบ่งปันรายงานที่ทำบุ๊กมาร์กของคุณกับเพื่อนร่วมงานที่มีสิทธิ์การเข้าถึงแบบอ่านรายงาน มุมมองของรายงานที่ทำบุ๊กมาร์กจะไม่แทนที่รายงานต้นฉบับของผู้ออกแบบ  การแบ่งปันกับเพื่อนร่วมงานที่ยังไม่มีสิทธิ์การเข้าถึงแบบจำเป็นต้องมีสิทธิ์การแชร์ต่อ หากคุณไม่สามารถแบ่งปันมุมมองของรายงานได้ โปรดติดต่อเจ้าของรายงานเพื่อร้องขอสิทธิ์การแชร์ต่อ  
...
เปิดแถบคำสั่งบุ๊กมาร์กโดยเลือก **บุ๊กมาร์ก** > **แสดงบุ๊กมาร์กเพิ่มเติม** จากแถบเมนู 

![ภาพหน้าจอของพื้นที่รายงานที่บานหน้าต่างบุ๊กมาร์กเปิดอยู่](media/end-user-bookmarks/power-bi-show-bookmarks.png)

ในการแปลงกลับไปยังมุมมองเริ่มต้นของรายงาน ให้เลือกไอคอน **ตั้งค่าใหม่**
...
หาก *ผู้ออกแบบ* รายงานมีบุ๊กมาร์กของรายงานให้ คุณจะพบบุ๊กมาร์กเหล่านั้นภายใต้หัวเรื่อง **บุ๊กมาร์กของรายงาน** หน้ารายงานนี้มีบุ๊กมาร์กสี่รายการ: B1, B2, VanArsdel YTD และ YTD ทั้งหมด **YTD ทั้งหมด** ถูกเลือกอยู่ในขณะนี้

> [!NOTE]
> คุณจะต้องใช้ Power BI Pro หรือ Premium เพื่อดูรายงานที่แชร์ 

![แสดงบุ๊กมาร์กของรายงาน](media/end-user-bookmarks/power-bi-bookmark-list.png)
...
หากคุณสามารถดูรายงานได้ คุณยังสามารถเพิ่มบุ๊กมาร์กส่วนบุคคลได้อีกด้วย  เมื่อคุณสร้างบุ๊กมาร์ก องค์ประกอบต่อไปนี้จะถูกบันทึกพร้อมบุ๊กมาร์ก:
...
กำหนดค่าหน้ารายงานตามที่คุณต้องการให้ปรากฏในบุ๊กมาร์ก ในตัวอย่างนี้:

1. เราได้เปลี่ยนตัวกรองวันที่บนบานหน้าต่าง **ตัวกรอง**
1. เปลี่ยนตัวกรองภูมิภาคบนบานหน้าต่าง **ตัวกรอง** และ
1.  และเลือกจุดข้อมูลบนวิชวลแผนภูมิโดนัทเพื่อกรองข้ามและไฮไลต์ข้ามพื้นที่รายงาน 

เมื่อหน้ารายงานของคุณและวิชวล ถูกจัดเรียงในแบบที่คุณต้องการแล้ว เลือก **เพิ่ม** จากบานหน้าต่าง **บุ๊กมาร์ก** เพื่อเพิ่มบุ๊กมาร์ก 

![เพิ่มบุ๊กมาร์กส่วนบุคคล](media/end-user-bookmarks/power-bi-personal.png)
...
เมื่อคุณมีบุ๊กมาร์กแล้ว แสดงบุ๊กมาร์กได้โดยการเลือกบนบุ๊กมาร์กในหน้าต่าง **บุ๊กมาร์ก** 
...
* วิชวลแบบกำหนดเองของ Power BI ส่วนใหญ่ควรทำงานได้ดีกับการบุ๊กมาร์ก ถ้าคุณพบปัญหากับการบุ๊กมาร์กและวิชวลแบบกำหนดเองของ Power BI ให้ติดต่อผู้สร้างวิชวลนั้น และขอให้พวกเขาจะเพิ่มการสนับสนุนบุ๊กมาร์ก    
...
[ตั้งค่าวิชวลส่วนบุคคลในรายงาน](end-user-personalize-visuals.md)
