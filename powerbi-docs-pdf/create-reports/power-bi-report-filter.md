...
อ่านเกี่ยวกับ [วิธีการใช้ตัวกรองของผู้อ่านรายงาน](../consumer/end-user-report-filter.md) ในรายงานของคุณ
...
อ่านเพิ่มเติมเกี่ยวกับ [การโต้ตอบกับตัวกรองในโหมดการอ่าน](../consumer/end-user-report-filter.md)
...
ในขณะที่คุณลักษณะการค้นหาบานหน้าต่างตัวกรองนี้จะเปิดใช้งานตามค่าเริ่มต้น แต่คุณยังสามารถเลือกที่จะเปิดหรือปิดได้โดยการเลือก **เปิดใช้งานการค้นหาบานหน้าต่างตัวกรอง** ในการตั้งค่า **รายงาน** ของกล่องโต้ตอบ **ตัวเลือก**
...
ภายใต้ส่วน **ประสบการณ์การกรอง** ของการตั้งค่า **รายงาน** คุณจะมีตัวเลือกในการควบคุมว่า ผู้ใช้สามารถเปลี่ยนชนิดตัวกรองได้หรือไม่

![จำกัดการเปลี่ยนแปลงสำหรับชนิดตัวกรอง](media/power-bi-report-filter/power-bi-enable-change-filter-type.png)

## <a name="allow-saving-filters"></a>อนุญาตให้บันทึกตัวกรอง

ตามค่าเริ่มต้น ผู้อ่านรายงานของคุณสามารถบันทึกตัวกรองสำหรับรายงานของคุณได้ คุณสามารถเลือกที่จะไม่อนุญาตให้บันทึกตัวกรองได้

- นอกจากนี้ ในการตั้งค่า **รายงาน** ของกล่องโต้ตอบ **ตัวเลือก** ภายใต้ **ตัวกรองแบบถาวร** ให้เลือก **ไม่อนุญาตให้ผู้ใช้บันทึกตัวกรองบนรายงานนี้**
...
## <a name="apply-filters-button"></a>ใช้งานปุ่มตัวกรอง
...
### <a name="turn-on-the-apply-button"></a>เปิดปุ่มนำไปใช้
...
- **ช่องทำเครื่องหมายและใช้สี** ควบคุมสีเติม 
