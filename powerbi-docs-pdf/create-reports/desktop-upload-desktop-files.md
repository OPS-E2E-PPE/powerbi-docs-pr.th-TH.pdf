...
2. ลงชื่อเข้าใช้ Power BI หากคุณยังไม่ได้ลงชื่อเข้าใช้
3. เลือกปลายทาง ตั้งแต่การเปิดตัวในเดือนกันยายน 2020 คุณจะสามารถค้นหารายการพื้นที่ทำงานที่มีอยู่ของคุณเพื่อค้นหาพื้นที่ทำงานที่คุณต้องการเผยแพร่ กล่องค้นหาช่วยให้คุณกรองพื้นที่ทำงานของคุณ เลือกพื้นที่ทำงาน จากนั้นคลิกปุ่ม **เลือก** เพื่อเผยแพร่
...
* [บทช่วยสอน: จัดรูปร่างและรวมข้อมูลใน Power BI Desktop](../connect-data/desktop-shape-and-combine-data.md)
