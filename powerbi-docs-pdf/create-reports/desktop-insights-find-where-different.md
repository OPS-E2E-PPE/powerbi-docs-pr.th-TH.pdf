...
* หมวดหมู่ย่อย: จักรยานทัวริ่ง จักรยานเสือภูเขา จักรยานเสือหมอบ (มีเพียงสามรายการเท่านั้น โดยมีข้อความ "...จากรายการทั้งหมด" รวมอยู่ด้วยเพื่อระบุว่ามีมากกว่าสามรายการที่มีผลกระทบอย่างมีนัยสำคัญ) 

* ช่องทาง = ทางตรง (เฉพาะรายการทางตรงเท่านั้น หากระดับผลกระทบสูงกว่าร้านค้ามาก)
...
* [ภาพรวมคิวรี่กับ Power BI Desktop](../transform-model/desktop-query-overview.md)
...
* [งานคิวรี่ที่ใช้บ่อยใน Power BI Desktop](../transform-model/desktop-common-query-tasks.md)   
