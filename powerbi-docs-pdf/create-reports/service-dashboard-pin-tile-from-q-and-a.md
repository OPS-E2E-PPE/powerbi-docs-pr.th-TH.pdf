...
Q&A เป็นเครื่องมือของ Power BI สำหรับการสำรวจข้อมูลของคุณโดยใช้ภาษาธรรมชาติ จำเป็นต้องค้นหาข้อมูลเชิงลึกที่เฉพาะเจาะจงหรือไม่ ถามคำถามเกี่ยวกับข้อมูลของคุณ และรับคำตอบในรูปแบบการแสดงภาพ

ในบทความวิธีการใช้งานนี้ เราเปิด[แดชบอร์ด](../consumer/end-user-dashboards.md)ในบริการ Power BI (app.powerbi.com) ถามคำถามโดยใช้ภาษาธรรมชาติเพื่อสร้างภาพ และปักหมุดการแสดงภาพนั้นที่แดชบอร์ด แดชบอร์ดไม่พร้อมใช้งานใน Power BI Desktop สำหรับข้อมูลใน Q&A กับเครื่องมือและเนื้อหา Power BI อื่น ๆ ให้ดู[Q&A ของ Power BI โดยภาพรวม](../consumer/end-user-q-and-a.md) 
...
1. เปิดแดชบอร์ดที่มีอย่างน้อยหนึ่งไทล์ที่ปักหมุดจากรายงาน เมื่อคุณถามคำถาม Power BI จะค้นหาคำตอบในชุดข้อมูลใดๆ ที่มีไทล์ถูกปักในแดชบอร์ดนั้น
...
[ภาพรวมของ Q&A ใน Power BI](../consumer/end-user-q-and-a.md)  
