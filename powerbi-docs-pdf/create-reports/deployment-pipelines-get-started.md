...
---
# <a name="get-started-with-deployment-pipelines"></a>เริ่มต้นกับไปป์ไลน์การปรับใช้
...
คุณสามารถสร้างไปป์ไลน์จากแท็บไปป์ไลน์การปรับใช้หรือจากพื้นที่ทำงาน
...
### <a name="create-a-pipeline-from-the-deployment-pipelines-tab"></a>สร้างไปป์ไลน์จากแท็บไปป์ไลน์การปรับใช้

หากต้องการสร้างไปป์ไลน์จากแท็บไปป์ไลน์การปรับใช้ ให้เดินเนินการดังนี้:

1. ใน Power BI service จากบานหน้าต่างนำทาง ให้เลือก **ไปป์ไลน์การปรับใช้** และจากนั้นเลือก **สร้างไปป์ไลน์**

2. ในกล่องโต้ตอบ *สร้างการปรับใช้ไปป์ไลน์* ใส่ชื่อและคำอธิบายสำหรับไปป์ไลน์และเลือก **สร้าง**

### <a name="create-a-pipeline-from-a-workspace"></a>สร้างไปป์ไลน์จากพื้นที่ทำงาน
...
1. จากพื้นที่ทำงาน ให้เลือก **สร้างไปป์ไลน์**

    > [!div class="mx-imgBorder"]
    > ![สกรีนช็อตของปุ่มสร้างไปป์ไลน์ในพื้นที่ทำงาน](media/deployment-pipelines-get-started/workspace-deploy.png)

2. ในกล่องโต้ตอบ *สร้างการปรับใช้ไปป์ไลน์* ใส่ชื่อและคำอธิบายสำหรับไปป์ไลน์และเลือก **สร้าง**

>[!NOTE]
>ถ้าพื้นที่ทำงานไม่ได้อยู่ในความจุ Premium ขององค์กร หรือความจุ PPU ของคุณ คุณจะได้รับการแจ้งเตือนเพื่อ [กำหนดพื้นที่ทำงานให้กับความจุ](../admin/service-admin-premium-manage.md#assign-a-workspace-to-a-capacity)  
...
1. ในไปป์ไลน์การปรับใช้ที่สร้างขึ้นใหม่ ให้เลือก **กำหนดพื้นที่ทำงาน**

2. ในเมนูดรอปดาวน์ *เลือกพื้นที่ทำงาน* เลือกพื้นที่ทำงานที่คุณต้องการกำหนดให้กับไปป์ไลน์

    >[!NOTE]
    >ถ้าคุณกำลังสร้างไปป์ไลน์จากพื้นที่ทำงาน คุณสามารถข้ามขั้นตอนนี้เนื่องจากมีการเลือกพื้นที่ทำงานอยู่แล้ว
...
* พื้นที่ทำงานต้องอยู่ใน [ความจุแบบ Premium](../admin/service-premium-what-is.md)
...
เลือกขั้นตอนที่จะปรับใช้และจากนั้นเลือกปุ่มปรับใช้ กระบวนการปรับใช้สร้างพื้นที่ทำงานซ้ำในขั้นตอนเป้าหมาย พื้นที่ทำงานนี้ประกอบด้วยเนื้อหาทั้งหมดที่มีอยู่ในขั้นตอนปัจจุบัน
...
เมื่อต้องการปรับใช้เฉพาะรายการที่ระบุ ให้เลือก **แสดงลิงก์เพิ่มเติม** แล้วจากนั้นเลือกรายการที่คุณต้องการปรับใช้ เมื่อคลิกปุ่มปรับใช้ เฉพาะรายการที่เลือกเท่านั้นที่จะถูกปรับใช้ในขั้นตอนถัดไป
...
การปรับใช้ไปยังขั้นตอนก่อนหน้านี้จะทำงานเฉพาะเมื่อขั้นตอนก่อนหน้าว่างเปล่า เมื่อปรับใช้กับขั้นตอนก่อนหน้า คุณไม่สามารถเลือกรายการที่ระบุได้ เนื้อหาทั้งหมดในขั้นตอนจะถูกปรับใช้
...
1. ในขั้นตอนไปป์ไลน์ที่คุณต้องการสร้างกฎชุดข้อมูล ให้เลือก **การตั้งค่าการปรับใช้**
...
3. เลือกชนิดของกฎที่คุณต้องการสร้าง ขยายรายการและจากนั้นเลือก **เพิ่มกฎ**
...
* **กฎแหล่งข้อมูล** รายการแหล่งข้อมูลจะถูกนำมาจากชุดข้อมูลของขั้นตอนไปป์ไลน์ต้นทาง จากรายการแหล่งข้อมูล เลือกแหล่งข้อมูลที่จะแทนที่ ใช้หนึ่งในวิธีต่อไปนี้เพื่อเลือกค่าที่จะแทนที่อีกค่าจากขั้นตอนต้นทาง:
    ...
    2. เลือก **อื่น ๆ** และเพิ่มแหล่งข้อมูลใหม่ด้วยตนเอง คุณสามารถเปลี่ยนไปยังแหล่งข้อมูลจากชนิดเดียวกันเท่านั้น
...
* ไม่สามารถกำหนดกฎพารามิเตอร์สำหรับพารามิเตอร์ที่มีชนิดเป็น *ทุกชนิด* หรือ *ไบนารี* สำหรับข้อมูลเพิ่มเติม โปรดดู [ข้อจำกัดของพารามิเตอร์การปรับปรุงชุดข้อมูล](/rest/api/power-bi/datasets/updateparameters)
...
ในการปรับใช้เนื้อหาไปยังขั้นตอนถัดไปในไปป์ไลน์การปรับใช้ ให้เลือกปุ่มปรับใช้ที่ด้านล่างของขั้นตอน
