...
> ความถี่:=COUNTROWS(\<Column Name\>)
> 
> 

บันทึกการเปลี่ยนแปลงของคุณ และกลับไปยังรายงานของคุณ เพิ่ม \<Column Name\> และความถี่ลงในตาราง จากนั้นแปลงเป็นแผนภูมิแท่ง ตรวจสอบให้ให้แน่ใจว่า \<Column Name\> อยู่บนแกน x และเขตข้อมูลจากการคำนวณอยู่บนแกน y
...
* หลีกเลี่ยงการทำให้แผนภูมิของคุณ รกไปด้วยป้ายชื่อข้อมูลที่ไม่จำเป็น ค่าในแผนภูมิแท่ง ***ถ้าใหญ่พอ** _ จะเข้าใจได้โดยไม่ต้องแสดงตัวเลขที่แท้จริง   
_ให้ความสนใจกับวิธีการชำระเงิน[แผนภูมิจะถูกเรียงลำดับ](../consumer/end-user-change-sort.md) ถ้าคุณต้องการดึงดูดความสนใจไปยังหมายเลขสูงสุดหรือต่ำสุด ให้เรียงลำดับตามหน่วยวัด ถ้าคุณต้องการให้บุคคลสามารถค้นหาประเภทใดประเภทหนึ่งได้อย่างรวดเร็วภายในประเภทอื่นๆมากมาย ให้เรียงลำดับตามแกน  
