...
ผู้จัดการของคุณต้องการดูรายงานเกี่ยวกับยอดขายล่าสุดและตัวเลขกำไรของคุณภายในเย็นวันนี้ แต่ข้อมูลล่าสุดอยู่ในไฟล์บนแล็ปท็อปของคุณ ในอดีตต้องใช้เวลาหลายชั่วโมงในการสร้างรายงานและคุณเริ่มรู้สึกตื่นตระหนก
...
- ดาวน์โหลด [สมุดงานตัวอย่างด้านการเงิน](https://go.microsoft.com/fwlink/?LinkID=521962) และบันทึกลงในคอมพิวเตอร์ของคุณหรือลงใน OneDrive for Business
...
1. หากต้องการแชร์ใน Teams ที่ด้านบนสุดของแดชบอร์ดให้เลือก **สนทนาในทีม**
