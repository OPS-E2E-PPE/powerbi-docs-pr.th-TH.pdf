...
**ข้อกำหนดเบื้องต้น**: ขั้นตอนแรกคือการออกแบบและสร้างรายงานในมุมมองเว็บปกติ หลังจากสร้างการรายงาน คุณสามารถปรับแต่งเพื่อให้เหมาะกับโทรศัพท์และแท็บเล็ตได้

ในการสร้างมุมมองที่ปรับให้เหมาะกับอุปกรณ์เคลื่อนที่ให้เปิดรายงานใน Power BI Desktop หรือในบริการ Power BI เมื่อเปิดรายงานไปที่มุมมองเค้าโครงอุปกรณ์เคลื่อนที่:
   * ใน Power BI Desktop ให้เลือก ribbon **มุมมอง** และเลือก **เค้าโครงโทรศัพท์มือถือ**
   * ในบริการ Power BI เลือก **แก้ไขรายงาน> เค้าโครงอุปกรณ์เคลื่อนที่** หากมองไม่เห็นตัวเลือกแก้ไขให้ดูภายใต้ **ตัวเลือกเพิ่มเติม (... )**
...
หากต้องการเพิ่มภาพลงในเค้าโครงโทรศัพท์มือถือ ให้ลากภาพจากบานหน้าต่าง **การแสดงผลด้วยภาพ** ไปยังพื้นที่ทำงานสำหรับโทรศัพท์ เมื่อคุณลากภาพไปยังพื้นที่ทำงาน ถาพจะจัดชิดกับเส้นตาราง อีกวิธีหนึ่งคือคุณสามารถคลิกสองครั้งที่การแสดงผลด้วยภาพในบานหน้าต่างการแสดงผลด้วยภาพจากนั้นภาพจะถูกเพิ่มลงในผืนผ้าใบ
...
ภาพสามารถจัดเรียงเป็นชั้นๆ ได้ เพื่อสร้างรายงานแบบโต้ตอบโดยใช้บุ๊กมาร์กหรือเพื่อสร้างรายงานที่น่าสนใจโดยการวางชั้นภาพไว้เหนือรูปภาพ คุณสามารถเปลี่ยนลำดับการแบ่งชั้นของการแสดงผลด้วยภาพได้ใน [บานหน้าต่างการเลือก](#set-the-layering-order-of-visuals-on-the-mobile-layout-canvas)
...
## <a name="set-the-layering-order-of-visuals-on-the-mobile-layout-canvas"></a>กำหนดลำดับการแบ่งชั้นของการแสดงผลด้วยภาพบนพื้นที่เค้าโครงอุปกรณ์เคลื่อนที่

ทุกครั้งที่คุณลากภาพลงบนพื้นที่ การแสดงผลด้วยภาพนั้นจะถูกเพิ่มลงบนเลเยอร์ของตัวเองที่ด้านบนของการแสดงผลด้วยภาพอื่น ๆ ที่มีอยู่แล้วบนพื้นที่ บานหน้าต่าง **การเลือก** ช่วยให้คุณสามารถเปลี่ยนลำดับการแบ่งชั้นได้

ในการเปิดบานหน้าต่าง **การเลือก** ให้คลิกปุ่ม **การเลือก** ในส่วน **แสดงบานหน้าต่าง** บนแท็บ **มุมมอง** 

บานหน้าต่าง **การเลือก** จะแสดงรายการการแสดงผลด้วยภาพทั้งหมดที่อยู่บนพื้นที่ ลำดับของรายการจะแสดงถึงลำดับชั้นบนพื้นที่ - การเรียงลำดับที่แสดงรายการแรกจะอยู่ที่ชั้นบนสุดส่วนการแสดงผลด้วยภาพที่แสดงรายการสุดท้ายจะอยู่ที่ชั้นล่างสุด ในการเปลี่ยนลำดับ คุณสามารถลากและวางการแสดงผลด้วยภาพไปยังที่อื่นในรายการหรือเลือกภาพและใช้ปุ่มลูกศรเพื่อเลื่อนขึ้นหรือลง

บานหน้าต่าง **การเลือก** ยังมีตัวบ่งชี้การมองเห็นสำหรับแต่ละการแสดงผลด้วยภาพในรายการ แต่ไม่สามารถเปลี่ยนการแสดงผลในมุมมองเค้าโครงอุปกรณ์เคลื่อนที่ได้ - ซึ่งต้องทำในมุมมองเค้าโครงเว็บปกติ
...
* [เอกสารประกอบ Power BI ในการสร้างรายงานและแดชบอร์ด](./index.yml)
