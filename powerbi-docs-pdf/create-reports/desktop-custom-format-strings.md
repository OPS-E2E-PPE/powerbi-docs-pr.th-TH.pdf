...
![สกรีนช็อตแสดง Power BI desktop ที่มีการเลือกรูปแบบที่กำหนดเอง ](media/desktop-custom-format-strings/custom-format-strings-01.png)
...
คุณสามารถดู[ตัวอย่าง](/office/vba/language/reference/user-interface-help/format-function-visual-basic-for-applications#example)ของวิธีการจัดรูปแบบสตริงของค่าแบบกำหนดเอง
...
* [สตริงรูปแบบแบบ VBA](/office/vba/language/reference/user-interface-help/format-function-visual-basic-for-applications#example)
