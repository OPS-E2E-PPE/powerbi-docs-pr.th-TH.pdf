...
---
# <a name="connect-to-sap-hana-databases-in-power-bi"></a>เชื่อมต่อกับฐานข้อมูลของ SAP HANA ใน Power BI
...
* ในขณะนี้ระบบไม่รองรับการรีเฟรช SAP Hana ด้วย SSO สำหรับสมุดงาน Excel ที่รีเฟรชในเวลาปัจจุบัน หากต้องการรีเฟรชข้อมูลใน Power BI คุณสามารถใช้รายงาน Power BI กับ SAP Hana SSO ได้
...
* [เปิดใช้งานการเข้ารหัสลับสำหรับ SAP HANA](desktop-sap-hana-encryption.md)
