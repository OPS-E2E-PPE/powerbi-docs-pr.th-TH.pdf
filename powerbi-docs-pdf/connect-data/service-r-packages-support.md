...
ms.locfileid: "98565536"
---
# <a name="create-visuals-by-using-r-packages-in-the-power-bi-service"></a>สร้างวิชวลโดยใช้แพ็คเกจ R ในบริการของ Power BI
...
แพ็คเกจ R รองรับการ **บริการ Power BI** ที่พบในส่วนต่อไปนี้ ชื่อว่า **แพ็คเกจที่ได้รับการสนับสนุน** ถ้าคุณต้องการขอรับการรองรับให้กับแพ็คเกจ R ที่ไม่พบในรายการที่แสดงอยู่ โปรดส่งคำขอของคุณมาที่ [Power BI Ideas](https://ideas.powerbi.com)
...
|ตลอดเวลา|0.3.3|https://cran.r-project.org/web/packages/anytime/index.html|
...
|อักขระ ^|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|เหรียญ|1.2-2|https://cran.r-project.org/web/packages/coin/index.html|
...
|สีเทียน|1.3.4|https://cran.r-project.org/web/packages/crayon/index.html|
...
|ชุดข้อมูล|3.4.4|NA|
|วันที่|1.2-38|https://cran.r-project.org/web/packages/date/index.html|
...
|การแยกย่อย|0.6.15|https://cran.r-project.org/web/packages/digest/index.html|
...
|โลก|4.6.2|https://cran.r-project.org/web/packages/earth/index.html|
...
|รูปวงรี|0.4.1|https://cran.r-project.org/web/packages/ellipse/index.html|
|จุดไข่ปลา|0.1.0|https://cran.r-project.org/web/packages/ellipsis/index.html|
...
|ภาษาอังกฤษ|1.2-3|https://cran.r-project.org/web/packages/english/index.html|
...
|เขตข้อมูล|9.6|https://cran.r-project.org/web/packages/fields/index.html|
...
|พยากรณ์|8.7|https://cran.r-project.org/web/packages/forecast/index.html|
...
|หนา|0.38.19|https://cran.r-project.org/web/packages/heavy/index.html|
...
|เมทริกซ์|1.2-12|https://cran.r-project.org/web/packages/Matrix/index.html|
...
|ช่วงเวลา|0.14|https://cran.r-project.org/web/packages/moments/index.html|
...
|พร็อกซี|0.4-21|https://cran.r-project.org/web/packages/proxy/index.html|
...
|ปรับรูปร่าง|0.8.7|https://cran.r-project.org/web/packages/reshape/index.html|
...
|ปรับขนาด|1.0.0|https://cran.r-project.org/web/packages/scales/index.html|
...
|การแบ่งส่วน|0.5-3.0|https://cran.r-project.org/web/packages/segmented/index.html|
...
|สแปม|2.1-3|https://cran.r-project.org/web/packages/spam/index.html|
...
|ไดอะแกรมเวนน์|1.6.20|https://cran.r-project.org/web/packages/VennDiagram/index.html|
