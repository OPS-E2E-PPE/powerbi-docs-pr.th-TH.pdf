...
ในบทช่วยสอนนี้ คุณเชื่อมต่อกับข้อมูลจริง: ที่เก็บข้อมูลสาธารณะของเนื้อหา Power BI (หรือที่เรียกว่า *ที่เก็บ*) ในบริการ GitHub Power BI จะสร้างแดชบอร์ดและรายงานด้วยข้อมูลโดยอัตโนมัติ คุณจะเห็นคำตอบสำหรับคำถามเช่น: มีบุคคลกี่คนให้การสนับสนุนที่เก็บสาธารณะของ Power BI ใครให้การสนับสนุนมากที่สุด วันใดในสัปดาห์ที่มีการสนับสนุนมากที่สุด และคำถามอื่นๆ 

คุณสามารถเชื่อมต่อกับที่เก็บ GitHub แบบส่วนตัวหรือสาธารณะของคุณเองได้เช่นกัน บทความ [เชื่อมต่อกับ GitHub ด้วย Power BI](service-connect-to-github.md) อธิบายวิธีใช้ *แอปเทมเพลต* Power BI เพื่อเชื่อมต่อกับที่เก็บของคุณ
...
- ลงทะเบียน [บัญชี GitHub](/contribute/get-started-setup-github)
...
> [เชื่อมต่อกับ GitHub ด้วยแอปเทมเพลต Power BI](service-connect-to-github.md)
