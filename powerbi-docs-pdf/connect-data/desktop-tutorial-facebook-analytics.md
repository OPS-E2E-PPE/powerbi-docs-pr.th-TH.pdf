...
หลังจากใช้การแปลงข้อมูลจนถึงตอนนี้ **ขั้นตอนที่นำมาใช้** ของคุณควรปรากฏดังนี้:
   ...
   >[!TIP]
   >**ขั้นตอนที่นำมาใช้** โดยพื้นฐานแล้วเป็นสูตรที่เขียนใน [ภาษาสูตร Power Query M](/powerquery-m/quick-tour-of-the-power-query-m-formula-language) เมื่อต้องการดูและแก้ไขสูตร เลือก **เครื่องมือแก้ไขขั้นสูง** ในกลุ่ม **คิวรี** ของแท็บ **หน้าแรก** ของริบบอน 
