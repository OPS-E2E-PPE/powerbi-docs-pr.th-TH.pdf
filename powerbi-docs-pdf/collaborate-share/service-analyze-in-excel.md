...
คุณต้องติดตั้ง **วิเคราะห์ใน Excel** จากลิงก์ที่ให้ไว้ในบริการของ Power BI Power BI ตรวจพบเวอร์ชันของ Excel ที่คุณมีในคอมพิวเตอร์ของคุณ และดาวน์โหลดเวอร์ชันที่เหมาะสม (32-bit หรือ 64-bit) โดยอัตโนมัติ คุณสามารถลงชื่อเข้าใช้บริการของ Power BI ได้ด้วยการเชื่อมโยงต่อไปนี้:

* [ลงชื่อเข้าใช้ Power BI](https://app.powerbi.com)

หลังจากที่คุณลงชื่อเข้าใช้และบริการของ Power BI กำลังทำงานในเบราว์เซอร์ของคุณให้เลือก **ตัวเลือกเพิ่มเติม**(...) ที่มุมบนขวาแล้วเลือก **ดาวน์โหลด > วิเคราะห์ใน Excel อัปเดต** รายการเมนูนี้นำไปใช้กับการติดตั้งการอัปเดตของการวิเคราะห์ใน Excel ใหม่
...
1. เลือก **วิเคราะห์ใน Excel** จากรายการเมนูที่ปรากฏขึ้น
    ...
    >[!Note]
    >วิเคราะห์ใน Excel ตอนนี้ดาวน์โหลดไฟล์ Excel แทนที่จะเป็นไฟล์ ODC ซึ่งเป็นการเปิดใช้งานการป้องกันข้อมูลบนข้อมูลที่ส่งออกจาก Power BI ไฟล์ Excel ที่ดาวน์โหลดมาจะสืบทอดป้ายชื่อระดับความลับของชุดข้อมูลที่เลือกสำหรับการวิเคราะห์ใน Excel
...
เมื่อใช้ Excel ในการวิเคราะห์ Power BI โดยใช้ PivotTable จะช่วยให้ Power BI ส่งต่อค่าของป้ายระดับความลับไปยัง Excel ป้ายบอกระดับความลับที่ใช้ในชุดข้อมูล Power BI จะถูกนำไปใช้กับไฟล์ Excel โดยอัตโนมัติเมื่อคุณสร้าง PivotTable ใน Excel 

ถ้าในเวลาต่อมาป้ายชื่อบนชุดข้อมูลมีการเปลี่ยนแปลงให้มีความรัดกุมมากขึ้น ป้ายชื่อที่ใช้ในไฟล์ Excel จะอัปเดตโดยอัตโนมัติเมื่อรีเฟรชข้อมูลใน Excel ถ้าชุดข้อมูลได้รับการเปลี่ยนแปลงให้มีความรัดกุมน้อยลง จะไม่มีการส่งต่อป้ายชื่อหรือการอัปเดต

ป้ายระดับความลับใน Excel ที่ตั้งไว้ด้วยตนเองจะไม่ถูกเขียนทับโดยป้ายระดับความลับของชุดข้อมูลโดยอัตโนมัติ ถ้าไฟล์ Excel มีป้ายระดับความลับที่ตั้งด้วยตัวเอง จะมีเคล็ดลับนโยบายปรากฏขึ้น โดยจะมีคำแนะนำให้อัปเกรดป้าย 

สำหรับข้อมูลเพิ่มเติม โปรดดู [วิธีการปรับใช้ป้ายบอกระดับความลับใน Power BI](../admin/service-security-apply-data-sensitivity-labels.md)
...
ต่อไปนี้คือข้อกำหนดบางอย่างสำหรับการใช้การ **วิเคราะห์ใน Excel**:
...
* ผู้ใช้สามารถเชื่อมต่อกับชุดข้อมูลผ่าน Analyze ใน Excel หากพวกเขามีสิทธิสำหรับชุดข้อมูลพื้นฐาน  ผู้ใช้สามารถมีสิทธิ์นี้ได้ในสองสามวิธีเช่นการมีบทบาทสมาชิกในพื้นที่ทำงานที่ประกอบด้วยชุดข้อมูลหรือมีสิทธิ์ในการสร้างชุดข้อมูลในพื้นที่ทำงานหรือในแอปที่มีชุดข้อมูล อ่านเพิ่มเติมเกี่ยวกับ[สิทธิในการสร้าง](../connect-data/service-datasets-build-permissions.md)สำหรับชุดข้อมูล
* ผู้ใช้ที่เป็นผู้เยี่ยมชมไม่สามารถใช้การ **วิเคราะห์ใน Excel** สำหรับชุดข้อมูลที่ส่งจาก (มาจาก) ผู้เช่าอื่น 
* **วิเคราะห์ใน Excel** เป็นคุณลักษณะบริการของ Power BI และไม่พร้อมใช้งานในเซิร์ฟเวอร์รายงาน Power BI หรือ Power BI Embedded 
* **Analyze ใน Excel** รองรับเฉพาะในคอมพิวเตอร์ที่ติดตั้ง Microsoft Windows


ถ้าคุณต้องการถอนการติดตั้งคุณลักษณะการ **วิเคราะห์ใน Excel** ให้ใช้การตั้งค่าการ **เพิ่มหรือเอาโปรแกรมออก** จากคอมพิวเตอร์ของคุณ

## <a name="limitations-and-considerations"></a>ข้อจำกัดและข้อควรพิจารณา

- การรักษาความปลอดภัยระดับแถว (RLS) ได้รับการสนับสนุนสำหรับการวิเคราะห์ใน Excel RLS จะถูกบังคับใช้ในระดับข้อมูลแบบจำลองและจะถูกนำไปให้ผู้ใช้ทุกคนเข้าถึงข้อมูลในรายงานเสมอ อ่านเพิ่มเติมเกี่ยวกับการ[รักษาความปลอดภัยระดับแถว](../admin/service-admin-rls.md)
- อาจมีบางครั้งที่เมื่อคุณใช้การวิเคราะห์ใน Excel คุณได้รับผลลัพธ์ที่ไม่คาดคิดหรือลักษณะการทำงานไม่ทำงานตามที่คุณคาดไว้ ดูการแก้ไขปัญหาการ [วิเคราะห์ใน Excel](desktop-troubleshooting-analyze-in-excel.md) สำหรับการแก้ไขปัญหาทั่วไป
