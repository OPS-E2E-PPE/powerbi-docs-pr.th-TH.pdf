...
---
# <a name="access-power-bi-featured-tables-in-excel-organization-data-types"></a>เข้าถึงตารางที่แนะนำของ Power BI ในชนิดข้อมูลขององค์กรแบบ Excel
...
หากคุณพบตารางที่คุณกำลังมองหา ให้กดเลือก นอกเหนือจากนี้ เลือก **เพิ่มเติมจากองค์กรของคุณ** Excel จะแสดงตารางที่แนะนำทั้งหมดที่คุณสามารถเข้าถึงได้ในบานหน้าต่าง
...
Excel จะแสดงตารางที่แนะนำทั้งหมดที่คุณสามารถเข้าถึงได้ ในบานหน้าต่าง **ตัวเลือกข้อมูล** ให้พิมพ์ในกล่อง **ตัวกรอง** เพื่อจำกัดตัวเลือกของคุณ เลือกตารางที่คุณต้องการใช้
...
แกลเลอรีชนิดข้อมูล Excel และประสบการณ์การเชื่อมต่อกับตารางที่แนะนำของ Power BI จะพร้อมใช้งานสำหรับสมาชิก Excel ที่มีแผนบริการ Power BI Pro 
...
ผู้ดูแลระบบ Power BI สามารถควบคุมกำหนดบุคคลในองค์กรที่สามารถใช้ตารางที่แนะนำในแกลเลอรีประเภทข้อมูล Excel ได้ ดู[อนุญาตให้เชื่อมต่อกับตารางที่แนะนำ](../admin/service-admin-portal.md#allow-connections-to-featured-tables)ในบทความพอร์ทัลผู้ดูแลระบบสำหรับรายละเอียด 
