...
- **ชุดเนื้อหาองค์กร**: คุณสามารถสร้างและใช้ชุดเนื้อหาองค์กรในพื้นที่ทำงานแบบคลาสสิกได้ คุณไม่สามารถสร้างและใช้ได้ในพื้นที่ทำงานใหม่ แอปและแอปเทมเพลตจะแทนที่ชุดเนื้อหาองค์กรในพื้นที่ทำงานใหม่ เรากำลังเลิกใช้งานชุดเนื้อหาระดับองค์กรแล้ว ตอนนี้เป็นเวลาที่เหมาะสมในการอัปเกรดชุดเนื้อหาของคุณไปยังแอป ดูส่วนแผนงานการอัปเกรดพื้นที่ทำงานของบล็อกโพสต์นี้ [การประกาศผู้ดูแลระบบ Power BI สามารถอัปเกรดพื้นที่ทำงานแบบคลาสสิก](https://powerbi.microsoft.com/blog/announcing-power-bi-admins-can-upgrade-classic-workspaces-and-roadmap-update/) สำหรับไทม์ไลน์
