...
ms.locfileid: "98861249"
---
# <a name="monitor-usage-metrics-in-classic-workspaces"></a>ตรวจสอบเมตริกการใช้งานในพื้นที่ทำงานแบบคลาสสิก

เมตริกการใช้งานช่วยให้คุณเข้าใจเกี่ยวกับผลกระทบของแดชบอร์ดและรายงานของคุณ เมื่อคุณเรียกใช้เมตริกการใช้งานแดชบอร์ดหรือเมตริกการใช้งานรายงาน คุณพบว่ามีการใช้แดชบอร์ดและรายงานเหล่านั้นทั่วทั้งองค์กรของคุณอย่างไร ใครบ้างที่ใช้ และเพื่อวัตถุประสงค์ใด บทความนี้สรุปรายงานเมตริกการใช้งานสำหรับ[พื้นที่ทำงานแบบคลาสสิก](service-create-workspaces.md) หากรายงานของคุณอยู่ในพื้นที่ทํางานใหม่ ให้ดูบทความ [ตรวจสอบเมตริกการใช้งานในประสบการณ์ใช้งานพื้นที่ทํางานใหม่](service-modern-usage-metrics.md)  
...
5. อีกทางหนึ่งคือ เลื่อนไปเหนือภาพแล้วเลือกไอคอนหมุดเพื่อเพิ่มการแสดงภาพไปยังแดชบอร์ด หรือจากแถบเมนูด้านบน เลือก **หน้า Pin Live** เพื่อเพิ่มทั้งหน้าไปยังแดชบอร์ดหนึ่ง จากแดชบอร์ด คุณสามารถตรวจสอบเมตริกการใช้งานได้ง่ายขึ้นหรือแชร์เมตริกการใช้งานกับผู้อื่นได้
...
2. เปิดรายงานในมุมมองการแก้ไข และ[โต้ตอบกับข้อมูลเช่นเดียวกับรายงาน Power BI อื่น ๆ](../create-reports/service-interact-with-a-report-in-editing-view.md) ตัวอย่างเช่น เพิ่มหน้าใหม่และสร้างการแสดงภาพแบบใหม่ เพิ่มตัวกรอง จัดรูปแบบตัวอักษร สี และอื่น ๆ
...
* เมตริกการใช้งานในบางครั้งอาจนับจำนวนเกินกว่ากิจกรรม ในสถานการณ์ที่ไคลเอ็นต์ รีเฟรชโดยไม่จำเป็นต้องมีคำขอที่ถูกส่งกลับไปยังบริการ Power BI ตัวอย่างเช่นการสลับหน้ารายงานจะไม่ออกคำขอการโหลดรายงานไปยังเซิร์ฟเวอร์เนื่องจากข้อกำหนดหน้าอยู่ในเบราว์เซอร์อยู่แล้ว
...
### <a name="discrepancies-between-rest-apis-and-usage-metrics"></a>ความขัดแย้งระหว่าง REST API และเมตริกการใช้งาน

Power BI [Reports REST API](/rest/api/power-bi/reports) และ [Admin REST API](/rest/api/power-bi/admin) ใช้ข้อมูลบริการของ Power BI ด้วยเช่นกัน สำหรับเหตุผลที่อธิบายไว้ในส่วนก่อนหน้านี้ การนับจำนวนรายงาน (จำนวนของรายงาน) จาก API อาจแตกต่างจากการนับจำนวนรายงานในเมตริกการใช้งาน จํานวนรายงานที่ได้จาก API จะไม่ได้รับผลกระทบจากปัญหาของไคลเอ็นต์และควรพิจารณาว่าถูกต้อง นอกจากนี้โปรดทราบว่า Api ของผู้ดูแลระบบให้คุณ "สถานะปัจจุบัน" ของการปรับใช้ Power BI และพิจารณาเฉพาะสิ่งที่มีอยู่ในเวลาของคำขอ รายงานเมตริกการใช้งานคลาสสิกมีวันที่๙๐ของข้อมูลและ "จำนวนทั้งหมด" มีหมายถึงรายงานที่ไม่ซ้ำกันที่ดูมากกว่า๙๐วัน ถ้ารายงานจะถูกลบออกหลังจากที่พวกเขาดูพวกเขาจะไม่ถูกนับโดย Api ผู้ดูแลระบบแต่จะนับในข้อมูลในอดีตการให้อาหารรายงานการใช้งาน

### <a name="classic-usage-metrics-are-not-supported-with-private-links"></a>ไม่รองรับเมตริกการใช้งานแบบคลาสสิกกับลิงก์ส่วนตัว 

หากองค์กรของคุณใช้[ลิงก์ส่วนตัว](../admin/service-security-private-links.md) รายงานเมตริกการใช้งานแบบคลาสสิกจะไม่มีข้อมูล ขณะนี้มีข้อจำกัดในการถ่ายโอนข้อมูลไคลเอนต์ผ่านลิงก์ส่วนตัว 
