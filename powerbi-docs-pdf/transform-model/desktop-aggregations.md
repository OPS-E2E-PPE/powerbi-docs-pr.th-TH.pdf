...
### <a name="regular-vs-limited-relationships"></a>ความสัมพันธ์แบบปกติเทียบกับแบบจำกัด

การรวมอิงที่ตามความสัมพันธ์จำเป็นต้องมีความสัมพันธ์แบบปกติ
...
กรณีเดียวที่ถือว่าความสัมพันธ์ *ข้ามแหล่งข้อมูล* เป็นแบบปกติ คือตารางทั้งสองถูกตั้งค่าเป็นโหมดนำเข้า ความสัมพันธ์แบบกลุ่มต่อกลุ่มนั้นถือว่าเป็นแบบจำกัดเสมอ
