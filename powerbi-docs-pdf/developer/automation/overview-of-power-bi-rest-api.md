...
| ดำเนินการจัดการกับออบเจ็กต์ Power BI | [การอ้างอิง Power BI REST API](/rest/api/power-bi/) |
...
| เครื่องมือ | คำอธิบาย |
|---------|-------------|
| [เครื่องมือ Playground](https://microsoft.github.io/PowerBI-JavaScript/demo) | พบตัวอย่างแบบเต็มของการใช้ Api ของไคลเอ็นต์ Power BI embedded analytics เครื่องมือนี้คือ วิธีที่รวดเร็วเพื่อลองเล่นกับตัวอย่าง Power BI Embedded ชนิดต่าง ๆ กันอีกด้วย |
| [Power BI แบบฝังตัววิเคราะห์ไคลเอ็นต์ Api](/javascript/api/overview/powerbi/) | เพื่อรับข้อมูลเพิ่มเติมเกี่ยวกับ Power BI ไคลเอ็นต์ Api |
...
* [Power BI แบบฝังตัววิเคราะห์ไคลเอ็นต์ Api](/javascript/api/overview/powerbi/)

## <a name="next-steps"></a>ขั้นตอนถัดไป

* [การพุชข้อมูลลงในชุดข้อมูล](walkthrough-push-data.md)
* [การพัฒนาวิชวลการ์ดวงกลมใน Power BI](../visuals/develop-circle-card.md)
