...
---
# <a name="power-bi-embedded-analytics-performance-best-practices"></a>แนวทางปฏิบัติที่ดีที่สุดสำหรับประสิทธิภาพการวิเคราะห์แบบฝังตัวของ Power BI
...
> [!NOTE]
> การสลับระหว่างรายงานเมื่อทำการฝังสำหรับลูกค้าของคุณ (เรียกอีกอย่างว่าสถานการณ์ 'แอปเป็นเจ้าของข้อมูล') ต้องใช้โทเค็นการฝังที่มีสิทธิ์ในการรายงานและชุดข้อมูลทั้งหมด สำหรับข้อมูลเพิ่มเติมดู [สร้างโทเค็น API](/rest/api/power-bi/embedtoken/generatetoken)
...
เรียกใช้ `powerbi.preload()` หากคุณไม่ได้ฝังรายงานไว้ทันที ตัวอย่างเช่น ถ้าเนื้อหาของ Power BI แบบฝังตัวไม่ปรากฏในโฮมเพจ ให้ใช้ `powerbi.preload()` เพื่อดาวน์โหลดและแคชในวัตถุที่ใช้สำหรับการฝังเนื้อหา
...
* [วิธีการแก้ไขปัญหาแบบฝังตัวของ Power BI](embedded-troubleshoot.md)
* [คำถามที่พบบ่อยเกี่ยวกับการวิเคราะห์แบบฝังตัวของ Power BI](embedded-faq.md)