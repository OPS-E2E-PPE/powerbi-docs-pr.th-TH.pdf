---
title: ฝังรายงานที่มีการแบ่งหน้าในแอปพลิเคชันการวิเคราะห์แบบฝังตัว Power BI สําหรับลูกค้าของคุณ
description: เรียนรู้วิธีการรวมหรือฝังรายงาน Power BI จนลงในแอปพลิเคชันการวิเคราะห์แบบฝังตัว
author: KesemSharabi
ms.author: kesharab
ms.reviewer: rkarlin
ms.topic: tutorial
...
* [ความจุ](#create-a-capacity)อย่างน้อย A4 หรือ P1 โดยมีการเปิดใช้งานปริมาณงาน [รายงานที่มีการแบ่งหน้า](../../admin/service-admin-premium-workloads.md#paginated-reports)
...
>* ไม่รองรับ [Premium Per User (PPU)](../../admin/service-premium-per-user-faq.md) คุณสามารถใช้ PPU เพื่อทดลองกับโซลูชันได้ แต่คุณจะไม่สามารถ[ย้ายไปที่การผลิต](move-to-production.md)ได้
...
การฝังรายงานที่มีการแบ่งหน้าต้องกำหนดพื้นที่ทำงานให้กับความจุก่อน และต้องอัปโหลดรายงานไปยังพื้นที่ทำงานด้วย
...
| --- | --- | --- | --- | --- |
| A1 ที่มี [Embedded Gen2](power-bi-embedded-generation-2.md) | 1 | 0.5 | 2.5 | 0.5 |
| A2 ที่มี [Embedded Gen2](power-bi-embedded-generation-2.md) | 2 | 1 | 5 | 1 |
| A3 ที่มี [Embedded Gen2](power-bi-embedded-generation-2.md) | 4 | 2 | 10 | 2 |
| P1/A4 | 8 | 4 | 25 | 4 |
| P2/A5 | 16 | 8 | 50 | 8 |
| P3/A6 | 32 | 16 | 100 | 16 |
| | | | | |

### <a name="assign-an-app-workspace-to-a-capacity"></a>กำหนดพื้นที่ทำงานของแอปไปยังความจุ

เมื่อคุณสร้างความจุแล้ว คุณสามารถกำหนดพื้นที่ทำงานแอปไปยังความจุนั้นได้

เมื่อต้องกำหนดความจุกับพื้นที่ทำงานโดยใช้[บริการหลัก](embed-service-principal.md) ให้ใช้[Power BI REST API](/rest/api/power-bi/capacities/groups_assigntocapacity) เมื่อคุณกำลังใช้ Power BI REST API ทำให้แน่ใจว่าใช้[ ID ออบเจ็กต์ของบริการหลัก](embed-service-principal.md)
...
คุณสามารถนำเข้ารายงานที่มีการแบ่งหน้าไปยังพื้นที่ทำงานใหม่ได้โดยใช้ [Power BI REST API](/rest/api/power-bi/imports/postimportingroup)
...
แม้ว่าขั้นตอนในการฝังรายงานที่มีการแบ่งหน้าของคุณอาจทำได้ด้วย [Power BI REST API](/rest/api/power-bi/) แต่ตัวอย่างรหัสที่อธิบายในบทความนี้ถูกสร้างด้วย **.NET SDK**
...
หากต้องการสร้าง Power BI Client ด้วย **โทเค็นการเข้าถึง** ให้สร้างออบเจ็กต์ไคลเอ็นต์ Power BI ซึ่งช่วยให้คุณสามารถติดต่อกับ [Power BI REST APIs](/rest/api/power-bi/) ได้ คุณสามารถสร้างวัตถุไคลเอ็นต์ Power BI ได้โดยการตัด **AccessToken** ด้วยวัตถุ **_TokenCredentials ที่เหลือ_**
...
สร้างโทเค็นฝังตัวซึ่งสามารถใช้ได้จาก Api ของไคลเอ็นต์ Power BI embedded analytics หากต้องการสร้างโทเค็นแบบฝังสำหรับการฝังรายงานที่มีการแบ่งหน้าของ Power BI ให้ใช้รายงาน API [Reports GenerateTokenInGroup](/rest/api/power-bi/embedtoken/reports_generatetokeningroup)
...
### <a name="load-an-item-using-the-client-apis"></a>โหลดรายการโดยใช้ Api ของไคลเอ็นต์

คุณสามารถใช้ Api ของไคลเอ็นต์ Power BI embedded analytics เพื่อโหลดรายงานจนลงในองค์ประกอบ div บนเว็บเพจของคุณ

สำหรับตัวอย่างแบบเต็มของการใช้ API ของไคลเอ็นต์คุณสามารถใช้[เครื่องมือสนามเด็กเล่น](https://microsoft.github.io/PowerBI-JavaScript/demo) เครื่องมือ Playground คือวิธีที่รวดเร็วเพื่อลองเล่นกับตัวอย่าง Power BI Embedded ชนิดต่าง ๆ กัน คุณยังสามารถรับข้อมูลเพิ่มเติมเกี่ยวกับ API ของไคลเอ็นต์ Power BI embedded analytics ได้โดยการเยี่ยมชมหน้า[api ของไคลเอ็นต์ POWER bi embedded analytics](/javascript/api/overview/powerbi/)
