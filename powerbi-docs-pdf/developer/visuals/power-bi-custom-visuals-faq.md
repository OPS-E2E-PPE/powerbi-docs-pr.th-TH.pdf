...
### <a name="if-an-admin-uploads-a-power-bi-visual-from-the-public-marketplace-to-the-organization-store-using-add-visual--from-appsource-is-it-automatically-updated-once-a-vendor-updates-the-visual-in-the-public-marketplace"></a>หากผู้ดูแลระบบอัปโหลดวิชวล Power BI จากตลาดสาธารณะไปยังร้านค้าขององค์กรโดยใช้ *เพิ่มวิชวล> จาก AppSource* จะมีการอัปเดตโดยอัตโนมัติเมื่อผู้ขายอัปเดตวิชวลในตลาดสาธารณะหรือไม่

ใช่ วิชวลจะได้รับการอัปเดตโดยอัตโนมัติจากตลาดกลางสาธารณะ หากวิชวลได้รับการรับรองการรับรองจะยังคงอยู่รวมถึงคุณลักษณะเพิ่มเติม เช่น การส่งออกเป็น PDF หรือ PowerPoint
...
กระบวนการส่งส่วนการจัดแสดง IAP Power BI ไปยังตลาดมีกระบวนการเหมือนกับส่วนการจัดแสดง Power BI ที่ไม่มีค่าใช้จ่าย คุณสามารถยื่นใบรับรองวิชวล Power BI ได้ใน [Partner Center](/partner-center/)
