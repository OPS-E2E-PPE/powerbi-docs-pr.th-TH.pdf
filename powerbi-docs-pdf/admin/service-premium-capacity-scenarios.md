...
> [!NOTE]
> สำหรับพรีเมี่ยม Gen2 และ [Gen2 Embedded](../developer/embedded/power-bi-embedded-generation-2.md)การใช้หน่วยความจำไม่จำเป็นต้องได้รับการติดตาม ขีดจำกัดเฉพาะใน Premium Gen2 และ Gen2 แบบฝังตัวอยู่ในหน่วยความจำของสิ่งประดิษฐ์เดียว ฟุตพริ้นท์ไม่สามารถเกินหน่วยความจำที่มีอยู่ในความจุได้ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ Premium Gen2 โปรดดูที่ [Power BI Premium Generation 2 (ตัวอย่าง)](service-premium-what-is.md#power-bi-premium-generation-2-preview)
...
> [!NOTE]
> สำหรับพรีเมี่ยม Gen2 และ [Gen2 Embedded](../developer/embedded/power-bi-embedded-generation-2.md)การใช้งานเวลาของ CPU จะถูกติดตามในระดับต่อสิ่งประดิษฐ์และสามารถมองเห็นได้ในแอปการใช้กำลังการผลิต อาร์ทิแฟกต์แต่ละรายการจะแสดงการใช้เวลา CPU ทั้งหมดตามช่วงเวลาที่กำหนด สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ Premium Gen2 โปรดดูที่ [Power BI Premium Generation 2 (ตัวอย่าง)](service-premium-what-is.md#power-bi-premium-generation-2-preview)
