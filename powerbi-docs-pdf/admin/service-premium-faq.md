...
**Power BI Premium Generation 2 คืออะไร**

Power BI Premium เพิ่งเปิดตัว Power BI Premium เวอร์ชันใหม่ **Premium Gen2** ที่กำลังอยู่ในช่วงการแสดงตัวอย่าง Premium Gen2 จะทำให้การจัดการความจุระดับพรีเมียมง่ายขึ้นและลดค่าใช้จ่ายในการจัดการ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ Premium Gen2 โปรดดูที่ [Power BI Premium Generation 2 (ตัวอย่าง)](service-premium-what-is.md#power-bi-premium-generation-2-preview)
...
คุณสามารถซื้อ Power BI Premium ตามจำนวนแกนเสมือนได้ คุณสามารถดูราคาได้ที่[ราคาหน้า Power BI](https://powerbi.microsoft.com/pricing/) สำหรับข้อมูลเพิ่มเติมบนโหนดและแกน v ดู [เอกสารทางเทคนิคของ Microsoft Power BI Premium](https://aka.ms/pbipremiumwhitepaper)

**"ความจุ" หมายความว่าอย่างไร?**  
ความจุคือกำลังการประมวลผลจำนวนหนึ่งที่สงวนไว้สำหรับองค์กรของคุณสำหรับการใช้งาน Power BI ซึ่งผู้ดูแลระบบบริการเป็นคนจัดเตรียมผ่านพอร์ทัลผู้ดูแลระบบ Power BI Premium ในหน้า **การจัดการความจุ**
