...
Power BI ใช้ **พื้นที่ว่างของ Azure** เพื่อป้องกันรายงาน Power bi แอปพลิเคชันและข้อมูลจากความล้มเหลว datacenter และจะถูกนำไปใช้และใช้งานโดยอัตโนมัติสำหรับ Power BI โซนความพร้อมใช้งานจะเป็นตำแหน่งที่ตั้งที่ผิดปกติภายในภูมิภาคของ Azure ซึ่งให้ค่าที่แตกต่างกันอย่างน้อยสามตำแหน่งและเฉพาะภายในภูมิภาค Azure ที่มี power ที่ซ้ำกันการทำความเย็นและเครือข่าย โซนความพร้อมใช้งานอนุญาตให้ลูกค้า Power BI ทำงานร่วมกับแอปพลิเคชันที่สำคัญกับการพร้อมใช้งานที่สูงขึ้นและการยอมรับข้อบกพร่องกับศูนย์ข้อมูล โซนความพร้อมใช้งานจะช่วยให้ลูกค้าสามารถทนต่อการล้มเหลวของศูนย์ข้อมูลผ่านการแยกข้อมูลซ้ำและแบบตรรกะของบริการ 

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ **โซนความพร้อมใช้งาน** ให้ดูบทต่อไปนี้ซึ่งจะเป็นไปตามรายละเอียดเกี่ยวกับ [ภูมิภาคและโซนความพร้อมใช้งานใน Azure](https://docs.microsoft.com/azure/availability-zones/az-overview)

## <a name="what-is-a-power-bi-failover"></a>การเฟลโอเวอร์ของ Power BI คืออะไร?

Power BI เก็บรักษาหลายอินสแตนซ์ของแต่ละองค์ประกอบในศูนย์ข้อมูล Azure (หรือที่รู้จักกันว่าภูมิภาค) เพื่อรับประกันความต่อเนื่องทางธุรกิจ หากมีกระแสไฟฟ้าดับหรือปัญหาที่ทำให้ Power BI ไม่สามารถเข้าถึงหรือใช้งานไม่ได้ในภูมิภาค Power BI จะล้มเหลว ทำให้องค์ประกอบทั้งหมดในภูมิภาคนั้นเป็นอินสแตนซ์สำรอง การการย้ายโหนดเมื่อเกิดข้อผิดพลาดจะเรียกคืนความพร้อมใช้งานและความสามารถการทำงานให้กับอินสแตนซ์ของบริการ Power BI ในภูมิภาคใหม่ (โดยปกติจะอยู่ในตำแหน่งทางภูมิศาสตร์เดียวกัน ตามที่ระบุไว้ใน [ Microsoft Trust Center ](https://www.microsoft.com/trust-center/product-overview))
...
อินสแตนซ์การสำรองข้อมูลอยู่ภายในตำแหน่งที่ตั้งทางภูมิศาสตร์ (ภูมิศาสตร์) เดียวกับที่คุณเลือกเมื่อองค์กรของคุณลงชื่อสมัครใช้ Power BI ยกเว้นที่ระบุไว้ใน [ Microsoft Trust Center ](https://www.microsoft.com/trust-center/product-overview) ภูมิศาสตร์อาจมีหลายภูมิภาคและ Microsoft อาจทำซ้ำข้อมูลไปยังภูมิภาคใด ๆ ภายในพื้นที่ทางภูมิศาสตร์ที่กำหนดสำหรับความยืดหยุ่นของข้อมูล Microsoft จะไม่ทำซ้ำหรือย้ายข้อมูลลูกค้านอกภูมิศาสตร์ สำหรับการแม็ปของตำแหน่งทางภูมิศาสตร์ที่นำเสนอโดย Power BI และภูมิภาคที่อยู่ภายในภูมิศาสตร์ดังกล่าว โปรดดู [ Microsoft Trust Center ](https://www.microsoft.com/trust-center/product-overview)

## <a name="how-does-microsoft-decide-to-fail-over"></a>Microsoft ตัดสินใจการเฟลโอเวอร์อย่างไร?
...
เมื่อมีการดำเนินการเฟลโอเวอร์ Power BI จะใช้การจำลอง Azure Storage GEO เพื่อดำเนินการเฟลโอเวอร์ การจำลองดังกล่าวมักจะมีจุดคืนค่า 15 นาที อย่างไรก็ตาม [Azure Storage ไม่รับประกันกรอบเวลานี้](/azure/storage/common/storage-redundancy) กับ SLA และดังนั้น Power BI ยังไม่สามารถรับประกันกรอบเวลาได้ 

## <a name="what-happens-to-workspaces-and-reports-if-my-premium-capacity-becomes-unavailable"></a>เกิดอะไรขึ้นกับพื้นที่ทำงานและรายงานถ้าความจุพรีเมียมของฉันไม่สามารถใช้ได้ 

ถ้าความจุพรีเมียมไม่สามารถใช้งานได้พื้นที่ทำงานและรายงานจะยังคงสามารถเข้าถึงได้และมองเห็นได้โดยผู้ใช้ที่ได้รับอนุญาตทั้งหมดที่มีการเข้าถึง Power BI Pro ทั้งหมดก่อนหน้านี้
...
หมายเลข ข้อมูลที่ต้องการจากแหล่งข้อมูลในองค์กร (รายงานและแดชบอร์ดใด ๆ ที่อิงตาม Direct Query และ Live Connect) จะไม่ทำงานในระหว่างการย้ายโหนดเมื่อเกิดข้อผิดพลาด อย่างไรก็ตาม การกำหนดค่าเกตเวย์จะไม่เปลี่ยนแปลง เมื่ออินสแตนซ์ Power BI กลับสู่สถานะเดิมเกตเวย์จะกลับสู่การทำงานตามปกติ

ในกรณีที่เกิดภัยพิบัติร้ายแรงในภูมิภาคหลักที่ทำให้ระบบไม่สามารถใช้งานออนไลน์ได้เป็นระยะเวลานานๆ ภูมิภาคหลักที่เฟลโอเวอร์จะอนุญาตการดำเนินการทั้งอ่านและเขียน อีกทั้งลูกค้าจะสามารถปรับใช้ใหม่และกำหนดค่าเกตเวย์ในภูมิภาคใหม่ได้อีกด้วย

ลูกค้าสามารถเลือกที่จะติดตั้งเกตเวย์ใหม่บนเครื่องอื่นหรือใช้เกตเวย์ที่มีอยู่ได้ การใช้เกตเวย์ที่มีอยู่ควรเป็นไปอย่างง่ายดายมากขึ้น เนื่องจากแหล่งข้อมูลทั้งหมดที่เกี่ยวข้องกับเกตเวย์เก่าจะถูกนำไปยังรายการใหม่
