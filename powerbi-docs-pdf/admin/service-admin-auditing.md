...
> [!NOTE]
> ไม่รองรับการบันทึกกิจกรรมสำหรับคลาวด์ Microsoft Deutschland เรียนรู้เพิ่มเติมเกี่ยวกับข้อจำกัดการบริการสำหรับคลาวด์ของเยอรมนีใน[คำถามที่พบบ่อยสำหรับ Power BI สำหรับลูกค้าคลาวด์ของเยอรมนี](service-govde-faq.md)
...
>
>
หากต้องการเรียนรู้เพิ่มเติมเกี่ยวกับการใช้ Power BI REST API รวมถึงตัวอย่างวิธีรับเหตุการณ์กิจกรรมการตรวจสอบ โปรดดูที่[ผู้ดูแลระบบ - รับกิจกรรมการเคลื่อนไหว](/rest/api/power-bi/admin/getactivityevents)ในคู่มืออ้างอิง Power BI REST API
...
> [!NOTE]
> ตัวอย่าง PowerShell พร้อมใช้งาน เพื่อช่วยให้คุณสามารถเรียนรู้วิธีการกรองและดึงข้อมูลเกี่ยวกับเหตุการณ์การบันทึกกิจกรรม Power BI ได้ สำหรับข้อมูลเพิ่มเติม โปรดดูที่ [เข้าถึงบันทึกกิจกรรม Power BI](../guidance/admin-activity-log.md)
...
นอกจากนี้คุณยังสามารถใช้ PowerShell เพื่อส่งออกผลลัพธ์การค้นหาของบันทึกการตรวจสอบของคุณ ตัวอย่างต่อไปนี้แสดงวิธีการส่งจากคำสั่ง [Search-UnifiedAuditLog](/powershell/module/exchange/policy-and-compliance-audit/search-unifiedauditlog?view=exchange-ps&preserve-view=true/) และส่งออกผลลัพธ์โดยใช้ [Export-Csv](/powershell/module/microsoft.powershell.utility/export-csv) cmdlet หากต้องการเรียกใช้สคริปต์ ผู้ดูแลระบบต้องกำหนดสิทธิ์ให้คุณอย่างเหมาะสม ตามที่อธิบายไว้ในการส่วนของ [ข้อกำหนดบันทึกการตรวจสอบ](#audit-log-requirements)
...
| สร้างพื้นที่ทำงานแอปเทมเพลต Power BI | CreateTemplateApp   |
| สร้างตั๋วการติดตั้งแอปเทมเพลต Power BI | CreateTemplateAppInstallTicket |
| สร้างแพ็กเกจแอปเทมเพลต Power BI | CreateTemplateAppPackage |
...
| ลบพื้นที่ทำงานแอปเทมเพลต Power BI แล้ว | DeleteTemplateApp |
| ลบแพ็กเกจแอปเทมเพลต Power BI แล้ว | DeleteTemplateAppPackage |
...
| แยกแพ็กเกจแม่แบบ Power BI ไปยังพื้นที่ทำงานแล้ว | ExtractTemplateAppPackage |
...
| สร้างสกรีนช็อต                       | สร้างสกรีนช็อต |                     |
| นำเข้าไฟล์ไปยัง Power BI แล้ว                         | นำเข้า                                      |                                          |
| ติดตั้ง Power BI แล้ว                            | InstallApp                                  |                                          |
| ติดตั้งแอปเทมเพลต Power BI แล้ว | InstallTemplateApp |
...
| เลื่อนระดับแพ็คเกจแอปเทมเพลต Power BI แล้ว | PromoteTemplateAppPackage |
...
| ใช้ป้ายชื่อระดับความลับ                         | ใช้ป้ายชื่อระดับความลับ                     |                                          |
| เปลี่ยนป้ายชื่อระดับความลับ                         | เปลี่ยนป้ายชื่อระดับความลับ                     |                                          |
| ลบป้ายชื่อระดับความลับออก                         | ลบป้ายชื่อระดับความลับออก                     |                                          |
...
| อัปเดตพารามิเตอร์แอปเทมเพลต Power BI ที่ติดตั้งแล้ว | UpdateInstalledTemplateAppParameters |
...
| อัปเดตการตั้งค่าแอปเทมเพลต Power BI แล้ว | UpdateTemplateAppSettings |
| อัปเดตสิทธิ์เข้าถึงการทดสอบแอปเทมเพลต Power BI แล้ว | UpdateTemplateAppTestPackagePermissions |
...
- [เข้าถึงบันทึกกิจกรรม Power BI](../guidance/admin-activity-log.md)
