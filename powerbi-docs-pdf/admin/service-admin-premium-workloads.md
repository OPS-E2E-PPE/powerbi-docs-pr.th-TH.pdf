...
> [!NOTE]
> **Premium Gen2** ที่กำลังอยู่ในช่วงการแสดงตัวอย่าง ไม่จำเป็นต้องเปลี่ยนการตั้งค่าหน่วยความจำ หน่วยความจำใน Premium Gen2 ได้รับการจัดการจากระบบพื้นฐานโดยอัตโนมัติ 


## <a name="workload-settings"></a>การตั้งค่าปริมาณงาน

ส่วนต่อไปนี้จะกล่าวถึงรายละเอียดเกี่ยวกับการตั้งค่าปริมาณงานที่อธิบายไว้ในตารางก่อนหน้า 
...
| **การรีเฟรชเพจอัตโนมัติ** | สลับเปิด/ปิดเพื่อสั่งให้พื้นที่ทำงานแบบพรีเมียมแสดงรายงานที่มีการรีเฟรชหน้าอัตโนมัติตามช่วงเวลาคงที่ |
...
| **เปลี่ยนหน่วยวัดการตรวจหา** | สลับเปิด/ปิดเพื่อสั่งให้พื้นที่ทำงานแบบพรีเมียมแสดงรายงานที่มีการรีเฟรชหน้าอัตโนมัติตามการตรวจหาการเปลี่ยนแปลง |
| **ช่วงการดำเนินการต่ำสุด** | หากหน่วยวัดการตรวจหาการเปลี่ยนแปลงเปิดอยู่ ระบบจะอนุญาตให้ดึงข้อมูลการเปลี่ยนแปลงข้อมูลตามรอบการดำเนินการต่ำสุด ค่าเริ่มต้นคือห้าวินาที และค่าต่ำสุดที่อนุญาตคือหนึ่งวินาที |
|  |  |  |
...
ปริมาณงานคุณสามารถเปิดใช้งาน และกำหนดความจุ โดยใช้[Capacitie](/rest/api/power-bi/capacities)REST APIs
